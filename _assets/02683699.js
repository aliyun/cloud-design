import {c as createElement, C as Component, B as Radio, I as useState, R as React, N as NextConfigProvider} from "./index.709df9fa.js";
import "./18f7e85f.js";
import {e as exported$1} from "./3f5ee03b.js";
import {N as NextMessage} from "./489b6da9.js";
...
const FooterButtonDemo = (props) => {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(exported, {
    onClick: () => {
      setVisible(true);
    },
    type: "primary"
  }, "Open dialog"), /* @__PURE__ */ React.createElement(exported$1, {
    title: "Welcome to Alibaba.com",
    visible,
    onOk: () => {
      setVisible(false);
    ...
    footer: [
      /* @__PURE__ */ React.createElement(exported, {
        type: "primary",
        loading: true
      }, "custom ok"),
      /* @__PURE__ */ React.createElement(exported, null, "custom cancle")
    ]
  }, "Start your business here by searching a popular product"));
};
...
function DemoComponent$6() {
  const content = /* @__PURE__ */ createElement("div", null, /* @__PURE__ */ createElement(Demo$6, null), /* @__PURE__ */ createElement(exported, {
    type: "primary",
    warning: true,
