import {c as createElement, F as createCommonjsModule, G as commonjsGlobal, H as getDefaultExportFromCjs} from "./index.79f375bb.js";
import {h as hooks} from "./cf6ed2e0.js";
import {N as NextCalendar} from "./854264f5.js";
import "./37808d5e.js";
  ...
  !function(b, f2) {
    ...
    return function(b) {
      function f2(c) {
        ...
        return b[c].call(t.exports, t, t.exports, f2), t.l = true, t.exports;
      }
      var e = {};
      return f2.m = b, f2.c = e, f2.d = function(b2, e2, c) {
        f2.o(b2, e2) || Object.defineProperty(b2, e2, {configurable: false, enumerable: true, get: c});
      }, f2.n = function(b2) {
        ...
        return f2.d(e2, "a", e2), e2;
      }, f2.o = function(b2, f3) {
        return Object.prototype.hasOwnProperty.call(b2, f3);
      }, f2.p = "", f2(f2.s = 0);
    }([function(b, f2, e) {
      ...
      f2.default = t.default, b.exports = f2.default;
    }, function(b, f2, e) {
      function c(b2) {
        return b2 && b2.__esModule ? b2 : {default: b2};
      }
      ...
      var t = e(2), a = c(t), r = e(3), n = c(r), d = e(4), u = c(d), s = e(5), o = c(s), l = e(6), i = c(l), p = e(7), y = c(p), h = e(8), v = c(h), g = e(9), D = c(g), M = e(10), _ = c(M), m = e(11), x = c(m), T = e(12), j = c(T), I = {lunarInfo: a.default, solarMonth: n.default, gan: u.default, zhi: o.default, animals: i.default, lunarTerm: y.default, lTermInfo: v.default, nStr1: D.default, nStr2: _.default, nStr3: x.default, nStr4: j.default, lYearDays: function(b2) {
        var f3, e2 = 348;
        for (f3 = 32768; f3 > 8; f3 >>= 1)
          e2 += I.lunarInfo[b2 - 1900] & f3 ? 1 : 0;
      ...
      }, monthDays: function(b2, f3) {
        return f3 > 12 || f3 < 1 ? -1 : I.lunarInfo[b2 - 1900] & 65536 >> f3 ? 30 : 29;
      }, solarDays: function(b2, f3) {
        if (f3 > 12 || f3 < 1)
          return -1;
        var e2 = f3 - 1;
        ...
        return parseInt(t2[f3 - 1]);
      }, toChinaYear: function(b2) {
        var f3 = parseInt(b2 / 1e3), e2 = parseInt(b2 % 1e3 / 100), c2 = parseInt(b2 % 100 / 10), t2 = b2 % 10;
        return I.nStr4[f3] + I.nStr4[e2] + I.nStr4[c2] + I.nStr4[t2] + "年";
        ...
        switch (b2) {
          ...
          case 30:
            ...
            break;
          default:
            f3 = I.nStr2[Math.floor(b2 / 10)], f3 += I.nStr1[b2 % 10];
        }
        return f3;
      }, getAnimal: function(b2) {
        return I.animals[(b2 - 4) % 12];
      }, solar2lunar: function(b2, f3, e2) {
        if (b2 < 1900 || b2 > 2100)
          return -1;
        if (b2 == 1900 && f3 == 1 && e2 < 31)
          return -1;
        if (b2)
          var c2 = new Date(b2, parseInt(f3) - 1, e2);
        else
          var c2 = new Date();
        var t2, a2 = 0, r2 = 0, b2 = c2.getFullYear(), f3 = c2.getMonth() + 1, e2 = c2.getDate(), n2 = (Date.UTC(c2.getFullYear(), c2.getMonth(), c2.getDate()) - Date.UTC(1900, 0, 31)) / 864e5;
        for (t2 = 1900; t2 < 2101 && n2 > 0; t2++)
          r2 = I.lYearDays(t2), n2 -= r2;
        n2 < 0 && (n2 += r2, t2--);
        var d2 = new Date(), u2 = false;
        d2.getFullYear() == b2 && d2.getMonth() + 1 == f3 && d2.getDate() == e2 && (u2 = true);
        ...
        var p2 = t2, y2 = n2 + 1, h2 = f3 - 1, v2 = I.getTerm(b2, 3), g2 = I.toGanZhi(b2 - 4), D2 = new Date(b2, 1, v2).getTime();
        new Date(b2, h2, e2).getTime() < D2 && (g2 = I.toGanZhi(b2 - 5));
        var M2 = I.getTerm(b2, 2 * f3 - 1), _2 = I.getTerm(b2, 2 * f3), m8 = I.toGanZhi(12 * (b2 - 1900) + f3 + 11);
        e2 >= M2 && (m8 = I.toGanZhi(12 * (b2 - 1900) + f3 + 12));
        var x2 = false, T2 = "";
        M2 == e2 && (x2 = true, T2 = I.lunarTerm[2 * f3 - 2]), _2 == e2 && (x2 = true, T2 = I.lunarTerm[2 * f3 - 1]);
        var j2 = Date.UTC(b2, h2, 1, 0, 0, 0, 0) / 864e5 + 25567 + 10, S = I.toGanZhi(j2 + e2 - 1);
        return {lYear: l2, lMonth: p2, lDay: y2, animal: I.getAnimal(l2), yearCn: I.toChinaYear(l2), monthCn: (i2 && a2 === p2 ? "闰" : "") + I.toChinaMonth(p2), dayCn: I.toChinaDay(y2), cYear: b2, cMonth: f3, cDay: e2, gzYear: g2, gzMonth: m8, gzDay: S, isToday: u2, isLeap: i2, nWeek: s2, ncWeek: "星期" + o2, isTerm: x2, term: T2};
      }, lunar2solar: function(b2, f3, e2, c2) {
        var t2 = I.leapMonth(b2);
        I.leapDays(b2);
        if (c2 && t2 != f3)
          return -1;
        if (b2 == 2100 && f3 == 12 && e2 > 1 || b2 == 1900 && f3 == 1 && e2 < 31)
          return -1;
        var a2 = I.monthDays(b2, f3);
        if (b2 < 1900 || b2 > 2100 || e2 > a2)
          return -1;
        for (var r2 = 0, n2 = 1900; n2 < b2; n2++)
          r2 += I.lYearDays(n2);
        for (var d2 = 0, u2 = false, n2 = 1; n2 < f3; n2++)
      ...
      f2.default = I, b.exports = f2.default;
    }, function(b, f2, e) {
      Object.defineProperty(f2, "__esModule", {value: true}), f2.default = [19416, 19168, 42352, 21717, 53856, 55632, 91476, 22176, 39632, 21970, 19168, 42422, 42192, 53840, 119381, 46400, 54944, 44450, 38320, 84343, 18800, 42160, 46261, 27216, 27968, 109396, 11104, 38256, 21234, 18800, 25958, 54432, 59984, 28309, 23248, 11104, 100067, 37600, 116951, 51536, 54432, 120998, 46416, 22176, 107956, 9680, 37584, 53938, 43344, 46423, 27808, 46416, 86869, 19872, 42416, 83315, 21168, 43432, 59728, 27296, 44710, 43856, 19296, 43748, 42352, 21088, 62051, 55632, 23383, 22176, 38608, 19925, 19152, 42192, 54484, 53840, 54616, 46400, 46752, 103846, 38320, 18864, 43380, 42160, 45690, 27216, 27968, 44870, 43872, 38256, 19189, 18800, 25776, 29859, 59984, 27480, 23232, 43872, 38613, 37600, 51552, 55636, 54432, 55888, 30034, 22176, 43959, 9