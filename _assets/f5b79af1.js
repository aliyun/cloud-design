...
var Body = (_temp2$1 = _class$2 = function(_React$Component) {
  ...
  Body2.prototype.render = function render() {
    ...
    var rows = React.createElement("tr", null, React.createElement("td", {colSpan: columns.length}, React.createElement("div", {
...
var VirtualBody = (_temp2$8 = _class$j = function(_React$Component) {
  ...
  VirtualBody2.prototype.render = function render() {
    ...
    return React.createElement("div", {style: {maxHeight: maxBodyHeight}, className, onScroll: this.onScroll}, React.createElement("div", {
      style: {
        height: bodyHeight,
        position: "relative"
      },
