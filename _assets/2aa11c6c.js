import {d as classnames, g as _extends, n as _typeof, _ as _inherits, a as _classCallCheck, b as _possibleConstructorReturn, o as obj, f as findDOMNode, t as dom, k as _objectWithoutProperties, R as React, i as propTypes, p as polyfill, D as NextMenu, s as NextIcon, K as KEYCODE, e as events, C as Component, N as NextConfigProvider, z as zhCN, q as log, L as Checkbox, B as Radio, m as Children$1, j as func, E as env, h as hoistNonReactStatics_cjs} from "./index.96485df2.js";
import {N as NextAffix} from "./f827df50.js";
import {N as NextButton} from "./e9807c39.js";
import {N as NextDropdown} from "./8300885a.js";
import {N as NextLoading} from "./389d12da.js";
var hasOwnProperty = Object.prototype.hasOwnProperty;
function transformEntryEqual(a2, b) {
  for (var k in a2) {
...
function transformEqual(a2, b) {
  ...
  for (var i = 0; i < a2.length; i++) {
    if (!transformEntryEqual(a2[i], b[i])) {
      return false;
    }
  }
  return true;
}
function shallowObjectEquals(a2, b) {
  var k;
  var i = 0;
  var j = 0;
  for (k in a2) {
    if (hasOwnProperty.call(a2, k)) {
      switch (k) {
        case "transform":
          if (!transformEqual(a2[k], b[k])) {
            return false;
          }
          break;
        case "shadowOffset":
          if (!shallowObjectEquals(a2[k], b[k])) {
            return false;
          }
          break;
        default:
  ...
  switch (typeof a2) {
    case "object":
      if (a2 instanceof Array) {
        for (var i = 0; i < a2.length; i++) {
          if (!styleEqual(a2[i], b[i])) {
            return false;
          }
        }
        return a2.length === b.length;
      } else {
        return shallowObjectEquals(a2, b);
      }
    case "number":
    default:
      return a2 === b;
...
function type(a2) {
  return Array.isArray(a2) ? "array" : typeof a2;
}
function elementEquals(a2, b) {
  var typeOfA = type(a2);
  var typeOfB = type(b);
  if (typeOfA !== typeOfB)
    return false;
  switch (typeOfA) {
    ...
    case "object":
      ...
      if (a2.ref !== b.ref)
        return false;
      return shallowElementEquals(a2.props, b.props);
    default:
      return a2 === b;
  }
}
function shallowElementEquals(a2, b) {
  var aCount = 0;
  var bCount = 0;
  for (var key in a2) {
    if (hasOwnProperty$1.call(a2, key)) {
      if (key === "style") {
        if (!styleEqual_1(a2[key], b[key]))
          return false;
  ...
  if (aCount !== bCount)
    return false;
  return elementEquals(a2.children, b.children);
}
...
var Sort = (_temp2$2 = _class$4 = function(_React$Component) {
  ...
  Sort2.prototype.renderSort = function renderSort() {
    ...
    var icons = ["asc", "desc"].map(function(sortOrder) {
      ...
      }, sortIcons ? sortIcons[sortOrder] : React.createElement(NextIcon, {rtl, type: map[sortOrder], size: "xs"}));
    });
    ...
    LockTable2.prototype.adjustIfTableNotNeedLock = function adjustIfTableNotNeedLock() {
      ...
      if (this.isOriginLock()) {
        var widthObj = this.tableInc.flatChildren.map(function(item, index) {
          ...
          return {
            cellWidths: a2.cellWidths + b.cellWidths,
            headerWidths: a2.headerWidths + b.headerWidths
          };
        }, {
          cellWidths: 0,
          headerWidths: 0
