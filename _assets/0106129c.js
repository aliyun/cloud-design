import {p as polyfill, _ as _inherits, a as _classCallCheck, b as _possibleConstructorReturn, j as _objectWithoutProperties, d as classnames, l as isValidElement, R as React, e as _extends, g as propTypes} from "./index.e76f7845.js";
import {o as obj, f as func, K as KEYCODE} from "./a3f37a66.js";
...
var NextSearch = NextConfigProvider.config(Search$1, {
  transfrom: function transfrom(props, deprecated) {
    var _props = _this.props, onInputFocus = _props.onInputFocus, overlayVisible = _props.overlayVisible, combox = _props.combox, others = _objectWithoutProperties(_props, ["onInputFocus", "overlayVisible", "combox"]);
    var newprops = others;
    if (onInputFocus) {
