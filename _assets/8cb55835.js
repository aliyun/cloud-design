import {p as polyfill, _ as _inherits, a as _classCallCheck, b as _possibleConstructorReturn, v as support, e as events, M as ReactDOM, t as dom, R as React, k as _objectWithoutProperties, m as Children, d as classnames, g as _extends, C as Component$2, i as propTypes, N as NextConfigProvider, s as NextIcon, c as createElement, S as Select} from "./index.8a2425f4.js";
import "./7bef0369.js";
import {N as NextProgress} from "./e6a5cc28.js";
import {B as Button} from "./db4a3e6e.js";
import {q as qe} from "./331485eb.js";
import "./d529a4f6.js";
import {w as withThemeClass} from "./96f44701.js";
var _class, _temp;
...
var StepItem = (_temp$1 = _class$1 = function(_Component) {
  ...
  StepItem2.prototype._getNode = function _getNode() {
    ...
    if (shape === "dot") {
      ...
      nodeElement = React.createElement(NextProgress, {shape: "circle", percent, className: prefix + "step-item-progress"});
  ...
  StepItem2.prototype.getNode = function getNode(args) {
    ...
    }, React.createElement("div", {className: prefix + "step-item-node-placeholder", onClick: this.onClick}, React.createElement("div", {
    ...
    if (!nodeElement) {
      finalNodeElement = React.createElement("div", {
        ...
        style: containerStyle,
        ref: this._refHandlerCreator("container")
      }, React.createElement("div", {className: prefix + "step-item-node-placeholder", onClick: this.onClick}, itemRender3(index, status, title, content)));
    }
    if (shape !== "arrow") {
      delete others.tabIndex;
      delete others["aria-current"];
    }
    return React.createElement("li", _extends({}, others, {style: this.getStyle(), className: stepCls, ref: this._refHandlerCreator("step")}), finalNodeElement, React.createElement("div", {
      className: prefix + "step-item-body",
      ref: this._refHandlerCreator("body"),
      tabIndex: this.props.tabIndex,
      "aria-current": this.props["aria-current"]
    }, React.createElement("div", {className: prefix + "step-item-title", ref: this._refHandlerCreator("title")}, title), React.createElement("div", {className: prefix + "step-item-content"}, content)), React.createElement("div", {className: prefix + "step-item-tail", ref: this._refHandlerCreator("tail")}, React.createElement("div", {className: prefix + "step-item-tail-underlay"}, React.createElement("div", {className: prefix + "step-item-tail-overlay", style: overlayCls}))));
  };
  ...
  StepItem2.prototype.render = function render() {
    ...
    var arrowElement = React.createElement("li", _extends({}, others, {style: this.getStyle(), className: stepCls, onClick: this.onClick}), React.createElement("div", {className: prefix + "step-item-container"}, React.createElement("div", {className: prefix + "step-item-title"}, title)));
...
function DemoComponent() {
  const content = /* @__PURE__ */ createElement("div", null, /* @__PURE__ */ createElement("h3", null, "Arrow"), /* @__PURE__ */ createElement(Step$2, {
    current: 1,
    shape: "arrow"
  }, steps), /* @__PURE__ */ createElement("h3", null, "Circle"), /* @__PURE__ */ createElement(Step$2, {
    current: 1,
    shape: "circle"
  }, steps), /* @__PURE__ */ createElement("h3", null, "Circle(Horizontal content)"), /* @__PURE__ */ createElement(Step$2, {
    current: 1,
    shape: "circle",
    labelPlacement: "hoz"
  }, steps), /* @__PURE__ */ createElement("h3", null, "Dot"), /* @__PURE__ */ createElement(Step$2, {
    current: 1,
    shape: "dot"
  }, steps));
...
const StepItem$2 = Step$2.Item, ButtonGroup = Button.Group;
const renders = {
...
class Component extends Component$2 {
  ...
  render() {
    ...
    return /* @__PURE__ */ createElement("div", null, /* @__PURE__ */ createElement("div", {
      ...
      value: index,
      key: index
    }, item)))), /* @__PURE__ */ createElement(Step$2, {
      ...
      onClick: this.onClick,
      content: "Description"
    })), /* @__PURE__ */ createElement("br", null), /* @__PURE__ */ createElement("br", null), /* @__PURE__ */ createElement(ButtonGroup, null, /* @__PURE__ */ createElement(Button, {
...
function DemoComponent$1() {
  const content = /* @__PURE__ */ createElement(Component, null);
...
function DemoComponent$2() {
  ...
  }, /* @__PURE__ */ createElement(Step$2, {
    current: 2,
    animation: false,
    itemRender
  }, steps$1.map((item) => /* @__PURE__ */ createElement(Step$2.Item, {
    key: item,
    title: item
  })))), /* @__PURE__ */ createElement("div", {
    className: "fusion-demo-item"
...
function DemoComponent$3() {
  const content = /* @__PURE__ */ createElement("div", null, /* @__PURE__ */ createElement(Step$2, {
    current: 1,
    direction: "ver",
    animation: false
  }, /* @__PURE__ */ createElement(Step$2.Item, {
    title: "Step 1",
  ...
  })), /* @__PURE__ */ createElement("br", null), /* @__PURE__ */ createElement("br", null), /* @__PURE__ */ createElement(Step$2, {
    current: 1,
    direction: "ver",
    shape: "dot",
    animation: false
...
const StepItem$3 = Step$2.Item, ButtonGroup$1 = Button.Group;
class Component$1 extends Component$2 {
  ...
  render() {
    const {currentStep} = this.state;
    return /* @__PURE__ */ createElement("div", null, /* @__PURE__ */ createElement(Step$2, {
      current: currentStep,
      readOnly: true
      ...
      title: "Step 6",
      onClick: this.onClick.bind(this)
    })), /* @__PURE__ */ createElement("br", null), /* @__PURE__ */ createElement("br", null), /* @__PURE__ */ createElement(ButtonGroup$1, null, /* @__PURE__ */ createElement(Button, {
      onClick: this.prev.bind(this),
      type: "primary",
      disabled: currentStep === 0
    }, "Backward"), /* @__PURE__ */ createElement(Button, {
...
function DemoComponent$6() {
  const content = /* @__PURE__ */ createElement(Component$1, null);
