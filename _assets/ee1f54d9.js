import {c as createElement, S as Select, C as Component, B as Radio, F as createCommonjsModule, s as NextIcon, d as classnames, w as NextInput} from "./index.26359282.js";
  ...
  render() {
    const menuProps = {
      ...
      header: /* @__PURE__ */ createElement("div", {
        ...
        onClick: (e2) => console.log(/onclick/),
        onMouseDown: (e2) => {
...
class App$2 extends Component {
  constructor() {
    ...
    this.onScroll = (e2) => {
      const scrollHeight = e2.target.scrollHeight;
      const clientHeight = e2.target.clientHeight;
