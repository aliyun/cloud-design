import {c as createElement, C as Component, s as NextIcon, I as Checkbox} from "./index.8a2425f4.js";
import "./7bef0369.js";
import "./563dbe52.js";
import {N as NextTree} from "./3675294a.js";
...
class Demo$6 extends Component {
  ...
  componentDidMount() {
    fetch("https://os.alipayobjects.com/rmsportal/ODDwqcDFTLAguOvWEolX.json").then((response) => response.json()).then((data2) => this.setState({data: formatDataSource([data2[0]])})).catch((e2) => console.log(e2));
  }
  render() {
    return /* @__PURE__ */ createElement(NextTree, {
      checkable: true,
