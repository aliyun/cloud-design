import {c as createElement, x as createCommonjsModule, y as commonjsGlobal, z as getDefaultExportFromCjs} from "./index.8f10cf2d.js";
...
var solarlunar_min = createCommonjsModule(function(module, exports) {
  !function(b, f) {
    ...
    return function(b) {
      ...
      Object.defineProperty(f, "__esModule", {value: true});
      var t = e(2), a = c(t), r = e(3), n = c(r), d = e(4), u = c(d), s = e(5), o = c(s), l = e(6), i = c(l), p = e(7), y = c(p), h = e(8), v = c(h), g = e(9), D = c(g), M = e(10), _2 = c(M), m = e(11), x = c(m), T = e(12), j = c(T), I = {lunarInfo: a.default, solarMonth: n.default, gan: u.default, zhi: o.default, animals: i.default, lunarTerm: y.default, lTermInfo: v.default, nStr1: D.default, nStr2: _2.default, nStr3: x.default, nStr4: j.default, lYearDays: function(b2) {
        var f2, e2 = 348;
        ...
        var M2 = I.getTerm(b2, 2 * f2 - 1), _3 = I.getTerm(b2, 2 * f2), m8 = I.toGanZhi(12 * (b2 - 1900) + f2 + 11);
        e2 >= M2 && (m8 = I.toGanZhi(12 * (b2 - 1900) + f2 + 12));
        var x2 = false, T2 = "";
        M2 == e2 && (x2 = true, T2 = I.lunarTerm[2 * f2 - 2]), _3 == e2 && (x2 = true, T2 = I.lunarTerm[2 * f2 - 1]);
