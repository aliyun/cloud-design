import {c as createElement, F as createCommonjsModule, G as commonjsGlobal, H as getDefaultExportFromCjs} from "./index.96485df2.js";
import {h as hooks} from "./cf6ed2e0.js";
import {N as NextCalendar} from "./f1bf8446.js";
import "./8300885a.js";
...
function DemoComponent() {
  const content = /* @__PURE__ */ createElement("div", null, /* @__PURE__ */ createElement(NextCalendar, {
...
function DemoComponent$2() {
  const content = /* @__PURE__ */ createElement(NextCalendar, {
    dateCellRender,
    monthCellRender
  });
...
function DemoComponent$5() {
  const content = /* @__PURE__ */ createElement(NextCalendar, null);
    ...
    return function(b) {
      ...
      var t = e(2), a2 = c(t), r = e(3), n = c(r), d = e(4), u = c(d), s = e(5), o = c(s), l = e(6), i = c(l), p = e(7), y = c(p), h = e(8), v = c(h), g = e(9), D = c(g), M = e(10), _ = c(M), m = e(11), x = c(m), T = e(12), j = c(T), I = {lunarInfo: a2.default, solarMonth: n.default, gan: u.default, zhi: o.default, animals: i.default, lunarTerm: y.default, lTermInfo: v.default, nStr1: D.default, nStr2: _.default, nStr3: x.default, nStr4: j.default, lYearDays: function(b2) {
        ...
        if (b2)
          ...
          var c2 = new Date();
        var t2, a3 = 0, r2 = 0, b2 = c2.getFullYear(), f2 = c2.getMonth() + 1, e2 = c2.getDate(), n2 = (Date.UTC(c2.getFullYear(), c2.getMonth(), c2.getDate()) - Date.UTC(1900, 0, 31)) / 864e5;
        ...
        s2 == 0 && (s2 = 7);
        var l2 = t2, a3 = I.leapMonth(t2), i2 = false;
        for (t2 = 1; t2 < 13 && n2 > 0; t2++)
          a3 > 0 && t2 == a3 + 1 && i2 == 0 ? (--t2, i2 = true, r2 = I.leapDays(l2)) : r2 = I.monthDays(l2, t2), i2 == 1 && t2 == a3 + 1 && (i2 = false), n2 -= r2;
        n2 == 0 && a3 > 0 && t2 == a3 + 1 && (i2 ? i2 = false : (i2 = true, --t2)), n2 < 0 && (n2 += r2, --t2);
        ...
        return {lYear: l2, lMonth: p2, lDay: y2, animal: I.getAnimal(l2), yearCn: I.toChinaYear(l2), monthCn: (i2 && a3 === p2 ? "闰" : "") + I.toChinaMonth(p2), dayCn: I.toChinaDay(y2), cYear: b2, cMonth: f2, cDay: e2, gzYear: g2, gzMonth: m8, gzDay: S, isToday: u2, isLeap: i2, nWeek: s2, ncWeek: "星期" + o2, isTerm: x2, term: T2};
        ...
        if (b2 == 2100 && f2 == 12 && e2 > 1 || b2 == 1900 && f2 == 1 && e2 < 31)
          return -1;
        var a3 = I.monthDays(b2, f2);
        if (b2 < 1900 || b2 > 2100 || e2 > a3)
          return -1;
