import {c as createElement, F as createCommonjsModule, G as commonjsGlobal, H as getDefaultExportFromCjs} from "./index.e4cec8f0.js";
import {h as hooks} from "./cf6ed2e0.js";
import {N as NextCalendar} from "./261233b2.js";
import "./9cbb9b47.js";
...
var solarlunar_min = createCommonjsModule(function(module, exports) {
  !function(b, f) {
    ...
    return function(b) {
      ...
      var e = {};
      return f.m = b, f.c = e, f.d = function(b3, e2, c) {
        f.o(b3, e2) || Object.defineProperty(b3, e2, {configurable: false, enumerable: true, get: c});
      }, f.n = function(b3) {
        var e2 = b3 && b3.__esModule ? function() {
          return b3.default;
        } : function() {
          return b3;
        };
        ...
        return Object.prototype.hasOwnProperty.call(b3, f2);
      }, f.p = "", f(f.s = 0);
    }([function(b, f, e) {
      Object.defineProperty(f, "__esModule", {value: true});
      var c = e(1), t = function(b3) {
      ...
      Object.defineProperty(f, "__esModule", {value: true});
      var t = e(2), a = c(t), r = e(3), n = c(r), d = e(4), u = c(d), s = e(5), o = c(s), l = e(6), i = c(l), p = e(7), y = c(p), h = e(8), v = c(h), g = e(9), D = c(g), M = e(10), _ = c(M), m = e(11), x = c(m), T = e(12), j = c(T), I = {lunarInfo: a.default, solarMonth: n.default, gan: u.default, zhi: o.default, animals: i.default, lunarTerm: y.default, lTermInfo: v.default, nStr1: D.default, nStr2: _.default, nStr3: x.default, nStr4: j.default, lYearDays: function(b3) {
        var f2, e2 = 348;
        for (f2 = 32768; f2 > 8; f2 >>= 1)
          e2 += I.lunarInfo[b3 - 1900] & f2 ? 1 : 0;
        return e2 + I.leapDays(b3);
      }, leapMonth: function(b3) {
        return 15 & I.lunarInfo[b3 - 1900];
      }, leapDays: function(b3) {
        return I.leapMonth(b3) ? 65536 & I.lunarInfo[b3 - 1900] ? 30 : 29 : 0;
      }, monthDays: function(b3, f2) {
        return f2 > 12 || f2 < 1 ? -1 : I.lunarInfo[b3 - 1900] & 65536 >> f2 ? 30 : 29;
      }, solarDays: function(b3, f2) {
        if (f2 > 12 || f2 < 1)
          return -1;
        var e2 = f2 - 1;
        return e2 == 1 ? b3 % 4 == 0 && b3 % 100 != 0 || b3 % 400 == 0 ? 29 : 28 : I.solarMonth[e2];
      }, toGanZhi: function(b3) {
        return I.gan[b3 % 10] + I.zhi[b3 % 12];
      }, getTerm: function(b3, f2) {
        if (b3 < 1900 || b3 > 2100)
          return -1;
        if (f2 < 1 || f2 > 24)
          return -1;
        var e2 = I.lTermInfo[b3 - 1900], c2 = [parseInt("0x" + e2.substr(0, 5)).toString(), parseInt("0x" + e2.substr(5, 5)).toString(), parseInt("0x" + e2.substr(10, 5)).toString(), parseInt("0x" + e2.substr(15, 5)).toString(), parseInt("0x" + e2.substr(20, 5)).toString(), parseInt("0x" + e2.substr(25, 5)).toString()], t2 = [c2[0].substr(0, 1), c2[0].substr(1, 2), c2[0].substr(3, 1), c2[0].substr(4, 2), c2[1].substr(0, 1), c2[1].substr(1, 2), c2[1].substr(3, 1), c2[1].substr(4, 2), c2[2].substr(0, 1), c2[2].substr(1, 2), c2[2].substr(3, 1), c2[2].substr(4, 2), c2[3].substr(0, 1), c2[3].substr(1, 2), c2[3].substr(3, 1), c2[3].substr(4, 2), c2[4].substr(0, 1), c2[4].substr(1, 2), c2[4].substr(3, 1), c2[4].substr(4, 2), c2[5].substr(0, 1), c2[5].substr(1, 2), c2[5].substr(3, 1), c2[5].substr(4, 2)];
        return parseInt(t2[f2 - 1]);
      }, toChinaYear: function(b3) {
        var f2 = parseInt(b3 / 1e3), e2 = parseInt(b3 % 1e3 / 100), c2 = parseInt(b3 % 100 / 10), t2 = b3 % 10;
        return I.nStr4[f2] + I.nStr4[e2] + I.nStr4[c2] + I.nStr4[t2] + "年";
      }, toChinaMonth: function(b3) {
        if (b3 > 12 || b3 < 1)
          return -1;
        var f2 = I.nStr3[b3 - 1];
        return f2 += "月";
      }, toChinaDay: function(b3) {
        var f2;
        switch (b3) {
          case 10:
            f2 = "初十";
          ...
          case 30:
            ...
            break;
          default:
            f2 = I.nStr2[Math.floor(b3 / 10)], f2 += I.nStr1[b3 % 10];
        }
        return f2;
      }, getAnimal: function(b3) {
        return I.animals[(b3 - 4) % 12];
      }, solar2lunar: function(b3, f2, e2) {
        if (b3 < 1900 || b3 > 2100)
          return -1;
        if (b3 == 1900 && f2 == 1 && e2 < 31)
          return -1;
        if (b3)
          var c2 = new Date(b3, parseInt(f2) - 1, e2);
        else
          var c2 = new Date();
        var t2, a2 = 0, r2 = 0, b3 = c2.getFullYear(), f2 = c2.getMonth() + 1, e2 = c2.getDate(), n2 = (Date.UTC(c2.getFullYear(), c2.getMonth(), c2.getDate()) - Date.UTC(1900, 0, 31)) / 864e5;
        for (t2 = 1900; t2 < 2101 && n2 > 0; t2++)
          r2 = I.lYearDays(t2), n2 -= r2;
        n2 < 0 && (n2 += r2, t2--);
        var d2 = new Date(), u2 = false;
        d2.getFullYear() == b3 && d2.getMonth() + 1 == f2 && d2.getDate() == e2 && (u2 = true);
        ...
        var p2 = t2, y2 = n2 + 1, h2 = f2 - 1, v2 = I.getTerm(b3, 3), g2 = I.toGanZhi(b3 - 4), D2 = new Date(b3, 1, v2).getTime();
        new Date(b3, h2, e2).getTime() < D2 && (g2 = I.toGanZhi(b3 - 5));
        var M2 = I.getTerm(b3, 2 * f2 - 1), _2 = I.getTerm(b3, 2 * f2), m8 = I.toGanZhi(12 * (b3 - 1900) + f2 + 11);
        e2 >= M2 && (m8 = I.toGanZhi(12 * (b3 - 1900) + f2 + 12));
        var x2 = false, T2 = "";
        M2 == e2 && (x2 = true, T2 = I.lunarTerm[2 * f2 - 2]), _2 == e2 && (x2 = true, T2 = I.lunarTerm[2 * f2 - 1]);
        var j2 = Date.UTC(b3, h2, 1, 0, 0, 0, 0) / 864e5 + 25567 + 10, S = I.toGanZhi(j2 + e2 - 1);
        return {lYear: l2, lMonth: p2, lDay: y2, animal: I.getAnimal(l2), yearCn: I.toChinaYear(l2), monthCn: (i2 && a2 === p2 ? "闰" : "") + I.toChinaMonth(p2), dayCn: I.toChinaDay(y2), cYear: b3, cMonth: f2, cDay: e2, gzYear: g2, gzMonth: m8, gzDay: S, isToday: u2, isLeap: i2, nWeek: s2, ncWeek: "星期" + o2, isTerm: x2, term: T2};
      }, lunar2solar: function(b3, f2, e2, c2) {
        var t2 = I.leapMonth(b3);
        I.leapDays(b3);
        if (c2 && t2 != f2)
          return -1;
        if (b3 == 2100 && f2 == 12 && e2 > 1 || b3 == 1900 && f2 == 1 && e2 < 31)
          return -1;
        var a2 = I.monthDays(b3, f2);
        if (b3 < 1900 || b3 > 2100 || e2 > a2)
          return -1;
        for (var r2 = 0, n2 = 1900; n2 < b3; n2++)
          r2 += I.lYearDays(n2);
        for (var d2 = 0, u2 = false, n2 = 1; n2 < f2; n2++)
          d2 = I.leapMonth(b3), u2 || d2 <= n2 && d2 > 0 && (r2 += I.leapDays(b3), u2 = true), r2 += I.monthDays(b3, n2);
        c2 && (r2 += a2);
