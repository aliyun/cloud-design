import {p as polyfill, _ as _inherits, a as _classCallCheck, b as _possibleConstructorReturn, g as _extends, d as classnames, R as React, s as NextIcon, o as obj, w as NextInput, i as propTypes, j as func, N as NextConfigProvider, q as log} from "./index.0806c9c7.js";
...
var NumberPicker = (_temp = _class = function(_React$Component) {
  ...
  NumberPicker2.prototype.onChange = function onChange(value, e) {
    if (this.props.editable === true) {
      ...
      if (value) {
        ...
        if (dotNum && dotNum.length > 1)
          value = value.substr(0, value.split(".", 2).join(".").length);
        var minusNum = value.match(/-/g);
        if (minusNum && minusNum.length > 1)
          value = value.substr(0, value.split("-", 2).join(".").length);
        if (dotIndex > -1) {
          if (precisionSet === 0)
            value = value.substr(0, dotIndex);
          else if (precisionCurrent > precisionSet)
            value = value.substr(0, dotIndex + 1 + precisionSet);
        }
  ...
  NumberPicker2.prototype.getInputNode = function getInputNode() {
...
var NumberPicker$2 = withThemeClass(NextNumberPicker);
export {NumberPicker$2 as N};
