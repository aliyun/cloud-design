import {c as createElement, C as Component, x as NextInput, R as React, I as Checkbox, D as Radio, S as Select} from "./index.b00c2d31.js";
import "./ba5cae7d.js";
import "./4c96482e.js";
import "./ff0d3eed.js";
...
import "./e9e5b55b.js";
import "./44c0f9b7.js";
import {N as NextDatePicker} from "./9bfe5cf5.js";
import {N as NextField} from "./0043017b.js";
import "./68cdd62d.js";
import {R as Range} from "./a302f885.js";
import {N as NextSwitch} from "./7e6a858c.js";
import {e as exported} from "./5fe84451.js";
import {N as NextTimePicker} from "./99680cd5.js";
...
import {c as connect, P as Provider} from "./364bed28.js";
class Demo extends Component {
  ...
  render() {
    return /* @__PURE__ */ createElement("div", null, this.state.show ? /* @__PURE__ */ createElement(NextInput, {
      ...
      style: {marginLeft: 4}
    }, "print"), /* @__PURE__ */ createElement(Button, {
...
class App extends Component {
  ...
  render() {
    ...
    }, "getValue"), /* @__PURE__ */ createElement(Button, {
      type: "primary",
      onClick: () => setValue("input", "set me by click")
    }, "setValue"), /* @__PURE__ */ createElement(Button, {
      onClick: () => reset()
    }, "reset"));
  }
}
...
class Demo$1 extends Component {
  constructor(props) {
    ...
    this.op = (value, index) => {
      return /* @__PURE__ */ createElement("span", null, /* @__PURE__ */ createElement(Button, {
        type: "primary",
        onClick: this.addItem.bind(this, index + 1)
      }, "add"), /* @__PURE__ */ createElement(Button, {
        warning: true,
...
function App$2() {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    style: {color: "red"}
  }, getError("input")), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement(Button, {
    onClick: onSetValue
  }, " setValue "), /* @__PURE__ */ React.createElement(Button, {
    onClick: onGetValue
  }, " getValue "), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("br", null));
}
function DemoComponent$4() {
  const content = /* @__PURE__ */ React.createElement(App$2, null);
  return /* @__PURE__ */ React.createElement(Style$4, null, content);
}
...
class App$3 extends Component {
  ...
  render() {
    ...
    }, "getValues"), /* @__PURE__ */ createElement(Button, {
      onClick: () => {
    ...
    }, "setValues"), /* @__PURE__ */ createElement(Button, {
      onClick: () => {
        this.field.reset();
      }
    }, "reset"));
...
class Demo$2 extends Component {
  ...
  render() {
    ...
    }), "now length is:", newLen.value, /* @__PURE__ */ createElement("p", null, "email: ", this.props.email), /* @__PURE__ */ createElement(Button, {
...
function DemoComponent$8() {
  const content = /* @__PURE__ */ createElement(Provider, {
    store
...
class App$6 extends Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ createElement("div", {
      ...
      style: {color: "red"}
    }, getError("input")), /* @__PURE__ */ createElement("br", null), /* @__PURE__ */ createElement(Button, {
      onClick: () => {
        setError("input", "set error 1");
      }
    }, "setError"), /* @__PURE__ */ createElement(Button, {
      onClick: () => {
        setErrors({input: "set error 2"});
      }
    }, "setErrors"), /* @__PURE__ */ createElement(Button, {
      onClick: () => {
        setErrors({input: ""});
      }
      ...
      style: {color: "red"}
    }, getError("input2")), /* @__PURE__ */ createElement("br", null), /* @__PURE__ */ createElement(Button, {
      onClick: () => {
...
class App$7 extends Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ createElement("div", {
    ...
    }), /* @__PURE__ */ createElement("br", null), /* @__PURE__ */ createElement("br", null), "result:", /* @__PURE__ */ createElement("pre", null, JSON.stringify(this.field.getValues(), null, 2)), /* @__PURE__ */ createElement("br", null), /* @__PURE__ */ createElement("br", null), /* @__PURE__ */ createElement(Button, {
      type: "primary",
      onClick: this.onGetValue.bind(this)
    }, "getValues"), /* @__PURE__ */ createElement(Button, {
      ...
      onClick: () => reset()
    }, "reset"), /* @__PURE__ */ createElement(Button, {
...
class App$8 extends Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ createElement("div", {
      ...
      style: {color: "red"}
    }, this.field.getError("checkboxgroup").join(",")) : "") : null, /* @__PURE__ */ createElement("br", null), /* @__PURE__ */ createElement("br", null), /* @__PURE__ */ createElement(Button, {
      type: "primary",
      onClick: () => {
    ...
    }, "validate"), /* @__PURE__ */ createElement(Button, {
      onClick: () => {
        reset();
      }
    }, "reset"), /* @__PURE__ */ createElement(Button, {
...
class App$9 extends React.Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ React.createElement("div", {
      ...
      style: {color: "red"}
    }, this.field.getError("checkbox").join(",")) : "", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement(Button, {
      type: "primary",
      onClick: () => {
...
function DemoComponent$c() {
  const content = /* @__PURE__ */ React.createElement(App$9, null);
  return /* @__PURE__ */ React.createElement(Style$c, null, content);
}
...
class App$a extends Component {
  ...
  render() {
    ...
    }), /* @__PURE__ */ createElement("br", null), /* @__PURE__ */ createElement(Button, {
      type: "primary",
      onClick: () => {
        console.log(this.field.getValues());
      }
