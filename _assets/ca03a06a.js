import {R as React, r as reactIs, h as hoistNonReactStatics_cjs, u as useContext, c as createElement} from "./index.d0c11305.js";
...
var T = function() {
  ...
  k.set(e, t), x.set(t, e);
}, L = "style[" + A + '][data-styled-version="5.2.1"]', G = new RegExp("^" + A + '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)'), F = function(e, t, n) {
  ...
  for (var n = t.innerHTML.split("/*!sc*/\n"), r = [], o = 0, s = n.length; o < s; o++) {
    ...
    if (i) {
      ...
      if (a) {
        ...
        c !== 0 && (z(u, c), F(e, u, a[3]), e.getTag().insertRules(c, r)), r.length = 0;
      } else
        r.push(i);
    }
  }
  ...
  function e(e2, t2, n) {
    e2 === void 0 && (e2 = E), t2 === void 0 && (t2 = {}), this.options = v({}, X, {}, e2), this.gs = t2, this.names = new Map(n), !this.options.isServer && I && J && (J = false, function(e3) {
      for (var t3 = document.querySelectorAll(L), n2 = 0, r = t3.length; n2 < r; n2++) {
        var o = t3[n2];
  ...
  return e.prototype.generateAndInjectStyles = function(e2, t, n) {
    ...
    if (this.baseStyle && o.push(this.baseStyle.generateAndInjectStyles(e2, t, n)), this.isStatic && !n.hash)
      if (this.staticRulesId && t.hasNameForId(r, this.staticRulesId))
        ...
        var s = Ne(this.rules, e2, t, n).join(""), i = ee(te(this.baseHash, s.length) >>> 0);
...
function ce(e) {
  var t, n, r, o, s = e === void 0 ? E : e, i = s.options, a = i === void 0 ? E : i, c = s.plugins, u = c === void 0 ? w : c, l = new stylis_min(a), d = [], h = function(e2) {
    ...
    return r2 === 0 && ae.includes(s2[n.length]) || s2.match(o) ? e2 : "." + t;
  };
...
function Ne(e, n, r, o) {
  ...
  return e instanceof ve ? r ? (e.inject(r, o), e.getName(o)) : e : S(e) ? function e2(t, n2) {
    var r2, o2, s2 = [];
    for (var i2 in t)
      t.hasOwnProperty(i2) && !_e(t[i2]) && (S(t[i2]) ? s2.push.apply(s2, e2(t[i2], i2)) : b(t[i2]) ? s2.push(be(i2) + ":", t[i2], ";") : s2.push(be(i2) + ": " + (r2 = i2, (o2 = t[i2]) == null || typeof o2 == "boolean" || o2 === "" ? "" : typeof o2 != "number" || o2 === 0 || r2 in unitlessKeys ? String(o2).trim() : o2 + "px") + ";"));
...
function Ae(e) {
  for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), r = 1; r < t; r++)
    n[r - 1] = arguments[r];
  return b(e) || S(e) ? Ne(g(w, [e].concat(n))) : n.length === 0 && e.length === 1 && typeof e[0] == "string" ? e : Ne(g(e, n));
}
...
function Ye(e, t, n) {
  var o = N(e), i = !ke(e), a = t.attrs, c = a === void 0 ? w : a, d = t.componentId, h = d === void 0 ? function(e2, t2) {
    var n2 = typeof e2 != "string" ? "sc" : je(e2);
    Fe[n2] = (Fe[n2] || 0) + 1;
    var r = n2 + "-" + Te("5.2.1" + n2 + Fe[n2]);
    return t2 ? t2 + "-" + r : r;
  }(t.displayName, t.parentComponentId) : d, p = t.displayName, f = p === void 0 ? function(e2) {
    return ke(e2) ? "styled." + e2 : "Styled(" + _(e2) + ")";
  }(e) : p, g2 = t.displayName && t.componentId ? je(t.displayName) + "-" + t.componentId : t.componentId || h, S2 = o && e.attrs ? Array.prototype.concat(e.attrs, c).filter(Boolean) : c, A2 = t.shouldForwardProp;
  o && e.shouldForwardProp && (A2 = t.shouldForwardProp ? function(n2, r) {
  ...
  var C, I2 = new se(n, g2, o ? e.componentStyle : void 0), P2 = I2.isStatic && c.length === 0, O = function(e2, t2) {
    return function(e3, t3, n2, r) {
      ...
      }(Oe(t3, useContext(ze), a2) || E, t3, o2), y = f2[0], g3 = f2[1], S3 = function(e4, t4, n3, r2) {
      ...
      for (var I3 in A3)
        I3[0] !== "$" && I3 !== "as" && (I3 === "forwardedAs" ? C2.as = A3[I3] : (d2 ? d2(I3, index) : !N2 || index(I3)) && (C2[I3] = A3[I3]));
      return t3.style && g3.style !== t3.style && (C2.style = v({}, t3.style, {}, g3.style)), C2.className = Array.prototype.concat(c2, h2, S3 !== h2 ? S3 : null, t3.className, g3.className).filter(Boolean).join(" "), C2.ref = w2, createElement(_2, C2);
    }(C, e2, t2, P2);
  };
  return O.displayName = f, (C = React.forwardRef(O)).attrs = S2, C.componentStyle = I2, C.displayName = f, C.shouldForwardProp = A2, C.foldedComponentIds = o ? Array.prototype.concat(e.foldedComponentIds, e.styledComponentId) : w, C.styledComponentId = g2, C.target = o ? e.target : e, C.withComponent = function(e2) {
    var r = t.componentId, o2 = function(e3, t2) {
      ...
      return o3;
    }(t, ["componentId"]), s = r && r + "-" + (ke(e2) ? e2 : je(_(e2)));
    return Ye(e2, v({}, o2, {attrs: S2, componentId: s}), n);
...
export {memoize as m, qe as q, stylis_min as s, unitlessKeys as u};
