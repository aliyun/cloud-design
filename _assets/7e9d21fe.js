import {p as polyfill, j as func, o as obj, _ as _inherits, a as _classCallCheck, b as _possibleConstructorReturn, g as _extends, K as KEYCODE, R as React, m as Children, d as classnames, y as NextSelect, C as Component, i as propTypes, Y as cloneElement, k as _objectWithoutProperties, l as isValidElement, N as NextConfigProvider, O as HOC, c as createElement} from "./index.0806c9c7.js";
import {N as NextTree, n as normalizeToArray, g as getAllCheckedKeys, f as filterParentKey, a as filterChildKey, i as isDescendantOrSelf, l as lodash_clonedeep} from "./dc0121ea.js";
...
var TreeSelect = (_temp = _class = function(_Component) {
  ...
  TreeSelect2.prototype.renderPreview = function renderPreview(data, others) {
    ...
    return React.createElement("p", _extends({}, others, {className: previewCls}), items && items.map(function(_ref) {
