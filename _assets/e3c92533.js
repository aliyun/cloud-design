import {T as createElement} from "./index.eccaf1a0.js";
const layoutProps = {};
...
function MDXContent({
  ...
  return /* @__PURE__ */ createElement(MDXLayout, {
    ...
    parentName: "p"
  }, `import {xxx} from '@alife/alicloud-components'`), `，从用户的视角来 import 组件库，而不应该用相对路径，以便我们将 demo 通过文档透出给用户。`, /* @__PURE__ */ createElement("inlineCode", {
    parentName: "p"
  }, `@alife/alicloud-components`), `会被映射到`, /* @__PURE__ */ createElement("inlineCode", {
    parentName: "p"
  }, `src/index.ts`)));
}
