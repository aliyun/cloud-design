...
import ConsoleMenu, { StyledComponents } from '@alife/alicloud-components-console-menu'
...
| `react-dom` | `^16.8.0` |
| `prop-types` | `^15.7.0` |
| `@alife/alicloud-components` | `^1.0.0` |

### 安装最新版本

```bash
npm i -S @alife/alicloud-components-console-menu
```
