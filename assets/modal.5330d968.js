import{r as e,B as t,ag as n,b as l}from"./index.26e635a6.js";import{q as a}from"./styled-components.browser.esm.08d92d51.js";const r=a.div`
  .custom-content {
    height: 2000px;
  }
...
`;var m=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:()=>{const[a,r]=e.useState(!1);return e.createElement(i,null,e.createElement("div",null,e.createElement(t,{onClick:()=>{r(!0)}},"打开Modal"),e.createElement(n,{title:"标题",description:"描述区域",visible:a,onClose:()=>{r(!1)},operations:e.createElement(e.Fragment,null,e.createElement(t,{type:"secondary"},e.createElement(l,{type:"edit"}),"编辑"),e.createElement(t,{type:"secondary"},e.createElement(l,{type:"success"}),"保存"))},e.createElement("div",{className:"custom-content"}))))}});const d={};d["_title-editable"]=c,d["_side-drawer"]=o,d._basic=m;export default d;
