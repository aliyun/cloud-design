import{r as e,ad as t,R as n}from"./index.e50fb7cb.js";import{q as l}from"./styled-components.browser.esm.4dfc2252.js";const{Item:a,SubNav:o}=t,r=e.createElement("span",{className:"fusion"},"FUSION"),c=e.createElement("a",{className:"login-in",href:"javascript:;"},"Login in");const m=l.div`
  .basic-nav .fusion {
    margin: 8px 20px;
    width: 100px;
    color: #ffffff;
...
`;var E=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement(p,null);return e.createElement(d,null,t)}});const v=l.div``;var b=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement("div",null,"请查看"," ",e.createElement("a",{target:"_blank",rel:"noopener noreferrer",href:"https://codepen.io/aboutblank/pen/JjdNKrm"},"https://codepen.io/aboutblank/pen/JjdNKrm"));return e.createElement(v,null,t)}});const{Item:h,Group:g}=t;const f=l.div``;var y=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement(t,{style:{width:240}},e.createElement(g,{label:"Group Label 1"},e.createElement(h,{icon:"account"},"Navigation One"),e.createElement(h,{icon:"account"},"Navigation Two"),e.createElement(h,{icon:"account"},"Navigation Three")),e.createElement(g,{label:"Group Label 2"},e.createElement(h,{icon:"account"},"Navigation Four"),e.createElement(h,{icon:"account"},"Navigation Five"),e.createElement(h,{icon:"account"},"Navigation Six")));return e.createElement(f,null,n)}});const{Item:I,SubNav:x}=t;class N extends e.Component{constructor(){super(...arguments),this.state={popupAlign:"follow"}}setValue(e){this.setState({popupAlign:e})}render(){const{popupAlign:l}=this.state;return e.createElement("div",null,e.createElement("div",{className:"demo-ctl"},e.createElement(n.Group,{shape:"button",size:"medium",value:l,onChange:this.setValue.bind(this)},e.createElement(n,{value:"follow"},'popupAlign="follow"'),e.createElement(n,{value:"outside"},'popupAlign="outside"'))),e.createElement(t,{style:{height:400,width:240},mode:"popup",popupAlign:l,defaultOpenKeys:["sub-nav-2"]},e.createElement(x,{key:"sub-nav-1",label:"Sub Nav 1"},e.createElement(I,{key:"1"},"Item 1")),e.createElement(x,{key:"sub-nav-2",label:"Sub Nav 2"},e.createElement(I,{key:"1"},"Item 1"),e.createElement(I,{key:"2"},"Item 2")),e.createElement(x,{key:"sub-nav-3",label:"Sub Nav 3"},e.createElement(I,{key:"1"},"Item 1"),e.createElement(I,{key:"2"},"Item 2"),e.createElement(I,{key:"3"},"Item 3")),e.createElement(x,{key:"sub-nav-4",label:"Sub Nav 4"},e.createElement(I,{key:"1"},"Item 1"),e.createElement(I,{key:"2"},"Item 2"),e.createElement(I,{key:"3"},"Item 3"),e.createElement(I,{key:"4"},"Item 4"))))}}const S=l.div`
  .demo-ctl {
    background-color: #f1f1f1;
    border-left: 4px solid #0d599a;
    color: #0a7ac3;
...
`;var _=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement(N,null);return e.createElement(S,null,t)}});const{Item:T,SubNav:k}=t;class z extends e.Component{constructor(){super(...arguments),this.state={iconOnly:!1,hasTooltip:!0,hasArrow:!0}}setValue(e,t){this.setState({[e]:"true"===t})}render(){const{iconOnly:l,hasTooltip:a,hasArrow:o}=this.state;return e.createElement("div",null,e.createElement("div",{className:"demo-ctl"},e.createElement(n.Group,{shape:"button",size:"medium",value:l?"true":"false",onChange:this.setValue.bind(this,"iconOnly")},e.createElement(n,{value:"true"},"iconOnly=true"),e.createElement(n,{value:"false"},"iconOnly=false")),l?e.createElement(n.Group,{shape:"button",size:"medium",value:o?"true":"false",onChange:this.setValue.bind(this,"hasArrow")},e.createElement(n,{value:"true"},"hasArrow=true"),e.createElement(n,{value:"false"},"hasArrow=false")):null,l?e.createElement(n.Group,{shape:"button",size:"medium",value:a?"true":"false",onChange:this.setValue.bind(this,"hasTooltip")},e.createElement(n,{value:"true"},"hasTooltip=true"),e.createElement(n,{value:"false"},"hasTooltip=false")):null),e.createElement(t,{style:{width:"200px"},iconOnly:l,hasArrow:o,hasTooltip:a},e.createElement(T,{icon:"account"},"Navigation One"),e.createElement(T,{icon:"account"},"Navigation Two"),e.createElement(T,{icon:"account"},"Navigation Three"),e.createElement(T,{icon:"account"},"Navigation Four"),e.createElement(T,{icon:"account"},"Navigation Five"),e.createElement(k,{icon:"account",label:"Sub Nav"},e.createElement(T,{icon:"account"},"Item 1"),e.createElement(T,{icon:"account"},"Item 2"),e.createElement(T,{icon:"account"},"Item 3"),e.createElement(T,{icon:"account"},"Item 4"))))}}const w=l.div`
  .demo-ctl {
    background-color: #f1f1f1;
    border-left: 4px solid #0d599a;
    color: #0a7ac3;
...
`;var A=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement(G,null);return e.createElement(j,null,t)}});const V={};V._basic=i,V._custom=E,V._fixed=b,V._group=y,V["_popup-align"]=_,V["_icon-only"]=O,V["_open-mode"]=A;export default V;
