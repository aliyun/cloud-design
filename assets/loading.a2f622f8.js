...
`;var ie=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement(i,{tip:"normal(size default large)"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{tip:"large",size:"large"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{tip:"medium",size:"medium"},t.createElement("div",{className:"demo"},"test")));return t.createElement(oe,null,e)}});const le=s.Item,se={labelCol:{fixedSpan:4},wrapperCol:{span:18}};class ce extends t.Component{constructor(e){super(e),this.state={visible:!1}}setVisible(e){this.setState({visible:e})}render(){return t.createElement("div",null,t.createElement(i,{visible:this.state.visible,shape:"fusion-reactor"},t.createElement(s,{style:{width:500}},t.createElement(le,e({label:"Username"},se),t.createElement(c,null)),t.createElement(le,e({label:"Password"},se),t.createElement(c,{htmlType:"password",placeholder:"please input"})),t.createElement(le,e({label:"Detail"},se),t.createElement(c,{multiple:!0})))),t.createElement("div",{style:{paddingLeft:80}},t.createElement(l,{onClick:this.setVisible.bind(this,!0),type:"primary"},"Submit"),t.createElement(l,{onClick:this.setVisible.bind(this,!1),style:{marginLeft:5}},"Cancel")))}}const ue=m.div``;var de=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(ce,null);return t.createElement(ue,null,e)}});const fe=m.div`
  .demo {
    width: 500px;
    background-color: #f2f3f7;
    text-align: center;
