import{r as e,G as t,b as n,B as l}from"./index.3d842b9a.js";import{q as a}from"./styled-components.browser.esm.b64bc59a.js";function c(e){console.log(`switch to ${e}`)}const s=a.div`
  .large-width {
    width: 100px;
  }
...
`;var m=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement(h,null);return e.createElement(u,null,t)}});function b(e){console.log(`switch to ${e}`)}const g=a.div`
  .large-width {
    width: 100px;
  }
