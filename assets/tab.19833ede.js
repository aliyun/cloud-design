...
`;var re=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=t.createElement(Q,{shape:"wrapped",tabRender:(n,a)=>t.createElement(ae,e({key:n},a))},oe.map((n=>t.createElement(Q.Item,e(e({key:n.key},n),{tabStyle:{height:"60px"}}),n.desc))));return t.createElement(ie,null,n)}});const se=[{tab:"Home",key:1},{tab:"Documnet",key:2},{tab:"Setting",key:3},{tab:"Help",key:4},{tab:"Admin",key:5},{tab:"More 1",key:6},{tab:"More 2",key:7},{tab:"More 3",key:8},{tab:"More 4",key:9},{tab:"More 5",key:10},{tab:"More 6",key:11},{tab:"More 7",key:12},{tab:"More 8",key:13},{tab:"More 9",key:14},{tab:"More 10",key:15},{tab:"More 11",key:16}];function le(e){console.log(e)}const ce=w.div`
...
`;var pe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo",style:{maxWidth:"520px"}},t.createElement("div",{className:"demo-item-title"},"Dropdown mode"),t.createElement(Q,{excessMode:"dropdown"},se.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab,onClick:le},e.tab," content, content, content")))),t.createElement("div",{className:"demo-item-title"},"Slide mode"),t.createElement(Q,{excessMode:"slide"},se.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab,onClick:le},e.tab," content, content, content")))));return t.createElement(ce,null,e)}});const me=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
...
`;var ye=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Q,{defaultActiveKey:"1",tabRender:be},t.createElement(Q.Item,{title:"Double Click To Edit Me",key:"1"},"Editable tab"),t.createElement(Q.Item,{title:"Double Click To Edit Me",key:"2"},"Editable tab"));return t.createElement(fe,null,e)}});const ve=[{tab:"Todo Tasks",key:0},{tab:"Finished Tasks",key:1},{tab:"Unread Messages",key:2},{tab:"Past Messages",key:3},{tab:"All Messages",key:4}],he={border:"1px solid #DCDEE3",padding:"20px"};const ge=w.div`
  .fusion-demo .demo-item-title {
    font-size: 16px;
    color: #333;
    padding: 8px;
...
`;var Ee=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},t.createElement("div",{className:"demo-item-title"},"Customize with contentStyle or contentClassName"),t.createElement(Q,{shape:"wrapped",contentStyle:he},ve.map((e=>t.createElement(Q.Item,{title:e.tab,key:e.key},e.tab)))),t.createElement("div",{className:"demo-item-title"},"Setting className and style in Tab.Item"),t.createElement(Q,{shape:"wrapped",navStyle:{background:"#DEE8FF"}},ve.map((e=>t.createElement(Q.Item,{title:e.tab,key:e.key,className:"custom-tab-item",style:{background:"#FFF"}},e.tab)))),t.createElement("div",{className:"demo-item-title"},"Tabs with equal width"),t.createElement(Q,{shape:"capsule"},ve.map((e=>t.createElement(Q.Item,{title:e.tab,key:e.key,className:"justify-tabs-tab"},e.tab)))));return t.createElement(ge,null,e)}});function ke(e){console.log(e)}const Te=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var xe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Q,{onChange:ke,shape:"wrapped"},t.createElement(Q.Item,{title:"Tab 1",key:"1"},t.createElement(Q,{shape:"wrapped"},t.createElement(Q.Item,{title:"1-1",key:"11"},"1-1"),t.createElement(Q.Item,{title:"1-2",key:"12"},"1-2"),t.createElement(Q.Item,{title:"1-3",key:"13"},"1-3"))),t.createElement(Q.Item,{title:"Tab 2",key:"2"},t.createElement(Q,{shape:"pure"},t.createElement(Q.Item,{title:"2-1",key:"21"},"2-1"),t.createElement(Q.Item,{title:"2-2",key:"22"},"2-2"),t.createElement(Q.Item,{title:"3-3",key:"23"},"2-3"))),t.createElement(Q.Item,{title:"Tab 3",key:"3"},t.createElement(Q,{shape:"capsule"},t.createElement(Q.Item,{title:"3-1",key:"31"},"3-1"),t.createElement(Q.Item,{title:"3-2",key:"32"},"3-2"),t.createElement(Q.Item,{title:"3-3",key:"33"},"3-3"))),t.createElement(Q.Item,{title:"Tab 4",key:"4"},t.createElement(Q,{shape:"text"},t.createElement(Q.Item,{title:"4-1",key:"41"},"4-1"),t.createElement(Q.Item,{title:"4-2",key:"42"},"4-2"),t.createElement(Q.Item,{title:"4-3",key:"43"},"4-3"))));return t.createElement(Te,null,e)}});const Ce=[{tab:"Home",key:0,content:"This is home page"},{tab:"Document",key:1,content:"This is document page"},{tab:"API",key:2,content:"This is api page"}];const we=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var Ie=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement("div",null,"Render all tab contents"),t.createElement(Q,{lazyLoad:!1},Ce.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("div",null,"Unmount inactive tabs"),t.createElement(Q,{unmountInactiveTabs:!0},Ce.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))));return t.createElement(we,null,e)}});class Ne extends t.Component{constructor(){super(...arguments),this.state={position:"top"},this.changePosition=e=>{this.setState({position:e})}}render(){return t.createElement("div",null,t.createElement(x,{onChange:this.changePosition,placeholder:"Choose Positon of Tab"},["top","bottom","left","right"].map((e=>t.createElement(x.Option,{value:e,key:e},e)))),t.createElement("br",null),t.createElement("br",null),t.createElement(Q,{tabPosition:this.state.position,shape:"wrapped",contentClassName:"custom-tab-content"},t.createElement(Q.Item,{title:"Tab 1",key:"1"},"Tab 1 Content"),t.createElement(Q.Item,{title:"Tab 2",key:"2"},"Tab 2 Content"),t.createElement(Q.Item,{title:"Tab 3",key:"3"},"Tab 3 Content")))}}const _e=w.div`
  .custom-tab-content {
    min-height: 50px;
  }
...
`;var Me=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Ne,null);return t.createElement(_e,null,e)}});const Se=[{tab:"Home",key:"home",content:"This is home page"},{tab:"Document",key:"doc",content:"This is document page"},{tab:"API",key:"api",content:"This is api page"}];const ze=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var Ke=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement(Q,{size:"small"},Se.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("br",null),t.createElement(Q,{size:"small",shape:"wrapped"},Se.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("br",null),t.createElement(Q,{size:"small",shape:"text"},Se.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("br",null),t.createElement(Q,{size:"small",shape:"capsule"},Se.map((e=>t.createElement(Q.TabPane,{key:e.key,title:e.tab},e.content)))));return t.createElement(ze,null,e)}});function De(e){console.log(e)}const Oe=t.createElement(k,{type:"primary",onClick:function(){console.log("hello world")}},"Hello world");const Pe=w.div`
  .fusion-demo .demo-item-title {
    font-size: 16px;
    color: #333;
    padding: 8px;
...
`;var Be=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},t.createElement("div",{className:"demo-item-title"},"Extra in Horizontal"),t.createElement(Q,{shape:"wrapped",onChange:De,extra:Oe},t.createElement(Q.Item,{title:"Tab 1",key:"1"},"Tab 1 Content"),t.createElement(Q.Item,{title:"Tab 2",key:"2"},"Tab 2 Content"),t.createElement(Q.Item,{title:"Tab 3",key:"3"},"Tab 3 Content")),t.createElement("div",{className:"demo-item-title"},"Extra in Vertical"),t.createElement(Q,{shape:"wrapped",tabPosition:"left",onChange:De,extra:Oe,contentClassName:"custom-tab-content"},t.createElement(Q.Item,{title:"Tab 1",key:"1"},"Tab 1 Content"),t.createElement(Q.Item,{title:"Tab 2",key:"2"},"Tab 2 Content"),t.createElement(Q.Item,{title:"Tab 3",key:"3"},"Tab 3 Content")));return t.createElement(Pe,null,e)}});function He(e){console.log(e)}const je=[{tab:"Home",key:"home",content:"This is home page"},{tab:"Document",key:"doc",content:"This is document page"},{tab:"API",key:"api",content:"This is api page"},{tab:"Repo",key:"repo",content:"This ia repo link"}],Re=["pure","wrapped","text","capsule"];const Ae=w.div`
  .fusion-demo-item {
    margin: 14px 0;
  }
...
`;var Le=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},Re.map((e=>t.createElement("div",{key:e,className:"fusion-demo-item"},t.createElement(Q,{shape:e,onChange:He},je.map((e=>t.createElement(Q.Item,{title:e.tab,key:e.key},e.content))))))));return t.createElement(Ae,null,e)}});const We=[{tab:"Home",key:0,content:"This is home page"},{tab:"Document",key:1,content:"This is document page"},{tab:"API",key:2,content:"This is api page"}];function Fe(e){console.log("change",e)}function Ue(e){console.log("click",e)}function Ve(e,t){console.log("enter",t.target,e)}function $e(e,t){console.log("leave",t.target,e)}const qe=w.div`
  .fusion-demo .demo-item-title {
    font-size: 16px;
    color: #333;
    padding: 8px;
...
`;var Ge=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},t.createElement("div",{className:"demo-item-title"},"Click to trigger change"),t.createElement(Q,{triggerType:"click",onChange:Fe},We.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab,onClick:Ue},e.content)))),t.createElement("div",{className:"demo-item-title"},"Hover to trigger change"),t.createElement(Q,{triggerType:"hover",onChange:Fe},We.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab,onClick:Ue,onMouseEnter:Ve,onMouseLeave:$e},e.content)))));return t.createElement(qe,null,e)}});const Je=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var Qe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Q,{disableKeyboard:!0},t.createElement(Q.Item,{title:"Home",key:"1"},"Home content"),t.createElement(Q.Item,{title:"Documentation",key:"2"},"Doc content"),t.createElement(Q.Item,{title:"Help",key:"3"},"Help Content"));return t.createElement(Je,null,e)}});const{Row:Xe,Col:Ye}=C,Ze=function(e){const t=[];for(let n=1;n<15;n++)t.push({tab:`tab ${n}`,key:n,content:`tab ${n} content`});return t}();const et=w.div`
  .custom-row {
...
`;var tt=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"custom-wrapper"},t.createElement(Xe,{className:"custom-row"},t.createElement(Ye,{fixedSpan:"12",className:"custom-col-sidebar"},"Sidebar"),t.createElement(Ye,{className:"custom-col-content"},t.createElement(Q,null,Ze.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))))));return t.createElement(et,null,e)}});const nt={};nt._basic=Y,nt._closable=ne,nt["_custom-tab"]=re,nt["_excess-mode"]=pe,nt._disabled=de,nt["_editable-tab"]=ye,nt["_custom-style"]=Ee,nt._nested=xe,nt["_lazy-load"]=Ie,nt._position=Me,nt._size=Ke,nt._extra=Be,nt._shape=Le,nt["_trigger-type"]=Ge,nt["_disable-keyboard"]=Qe,nt["_tab-in-grid"]=tt;export default nt;
