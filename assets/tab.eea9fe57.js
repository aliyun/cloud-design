...
`;var ne=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},t.createElement("div",{className:"demo-item-title"},"Customize with contentStyle or contentClassName"),t.createElement(Q,{shape:"wrapped",contentStyle:ee},Z.map((e=>t.createElement(Q.Item,{title:e.tab,key:e.key},e.tab)))),t.createElement("div",{className:"demo-item-title"},"Setting className and style in Tab.Item"),t.createElement(Q,{shape:"wrapped",navStyle:{background:"#DEE8FF"}},Z.map((e=>t.createElement(Q.Item,{title:e.tab,key:e.key,className:"custom-tab-item",style:{background:"#FFF"}},e.tab)))),t.createElement("div",{className:"demo-item-title"},"Tabs with equal width"),t.createElement(Q,{shape:"capsule"},Z.map((e=>t.createElement(Q.Item,{title:e.tab,key:e.key,className:"justify-tabs-tab"},e.tab)))));return t.createElement(te,null,e)}});const ae=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var oe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Q,{disableKeyboard:!0},t.createElement(Q.Item,{title:"Home",key:"1"},"Home content"),t.createElement(Q.Item,{title:"Documentation",key:"2"},"Doc content"),t.createElement(Q.Item,{title:"Help",key:"3"},"Help Content"));return t.createElement(ae,null,e)}});const ie=[{tab:"Mail",key:1,closeable:!1},{tab:"Message",key:2,closeable:!0},{tab:"Setting",key:3,closeable:!0},{tab:"Unread",key:4,closeable:!0}];class re extends t.Component{constructor(e){super(e),this.onClose=e=>{this.remove(e)},this.onChange=e=>{this.setState({activeKey:e})},this.addTabpane=()=>{this.setState((e=>{const{panes:t}=e;return t.push({tab:"new tab",key:Math.random(),closeable:!0}),{panes:t}}))},this.state={panes:ie,activeKey:ie[0].key}}remove(e){let t=this.state.activeKey;const n=[];this.state.panes.forEach((t=>{t.key!=e&&n.push(t)})),e==t&&(t=n[0].key),this.setState({panes:n,activeKey:t})}render(){const e=this.state;return t.createElement("div",null,t.createElement(k,{onClick:this.addTabpane,size:"large",type:"primary"},t.createElement(s,{type:"add"})," New Tab"),t.createElement(Q,{shape:"wrapped",activeKey:e.activeKey,onChange:this.onChange,onClose:this.onClose,className:"custom-tab"},e.panes.map((e=>t.createElement(Q.Item,{title:e.tab,key:e.key,closeable:e.closeable},e.tab," content")))))}}const se=w.div`
  .custom-tab {
    margin-top: 14px;
  }
...
`;var be=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Q,null,t.createElement(Q.Item,{title:"Tab 1",disabled:!0,key:"1"},"Tab 1 content"),t.createElement(Q.Item,{title:"Tab 2",key:"2"},"Tab 2 content"),t.createElement(Q.Item,{title:"Tab 3",key:"3"},"Tab 3 content"));return t.createElement(ue,null,e)}});class fe extends t.Component{constructor(e){super(e),this.onKeyDown=e=>{const{keyCode:t}=e;t>36&&t<41&&e.stopPropagation()},this.onBlur=e=>{this.setState({editable:!1,tabTitle:e.target.value})},this.onDblClick=()=>{this.setState({editable:!0})},this.state={tabTitle:e.defaultTitle,editable:!1}}componentWillReceiveProps(e){e.defaultTitle!==this.state.tabTitle&&this.setState({tabTitle:e.defaultTitle})}render(){const{tabTitle:e,editable:n}=this.state;return n?t.createElement(T,{defaultValue:e,onKeyDown:this.onKeyDown,onBlur:this.onBlur}):t.createElement("span",{onDoubleClick:this.onDblClick},e)}}const ye=(e,{title:n})=>t.createElement("div",{key:e,className:"editable-tab-wrapper"},t.createElement(fe,{defaultTitle:n}));const ve=w.div`
...
`;var Pe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(De,null);return t.createElement(Oe,null,e)}});const Be=[{tab:"Home",key:"home",content:"This is home page"},{tab:"Document",key:"doc",content:"This is document page"},{tab:"API",key:"api",content:"This is api page"}];const He=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
...
`;var Fe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},Le.map((e=>t.createElement("div",{key:e,className:"fusion-demo-item"},t.createElement(Q,{shape:e,onChange:Re},Ae.map((e=>t.createElement(Q.Item,{title:e.tab,key:e.key},e.content))))))));return t.createElement(We,null,e)}});const Ue=[{tab:"Home",key:0,content:"This is home page"},{tab:"Document",key:1,content:"This is document page"},{tab:"API",key:2,content:"This is api page"}];function Ve(e){console.log("change",e)}function $e(e){console.log("click",e)}function qe(e,t){console.log("enter",t.target,e)}function Ge(e,t){console.log("leave",t.target,e)}const Je=w.div`
  .fusion-demo .demo-item-title {
    font-size: 16px;
    color: #333;
    padding: 8px;
...
`;var Qe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},t.createElement("div",{className:"demo-item-title"},"Click to trigger change"),t.createElement(Q,{triggerType:"click",onChange:Ve},Ue.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab,onClick:$e},e.content)))),t.createElement("div",{className:"demo-item-title"},"Hover to trigger change"),t.createElement(Q,{triggerType:"hover",onChange:Ve},Ue.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab,onClick:$e,onMouseEnter:qe,onMouseLeave:Ge},e.content)))));return t.createElement(Je,null,e)}});const{Row:Xe,Col:Ye}=C,Ze=function(e){const t=[];for(let n=1;n<15;n++)t.push({tab:`tab ${n}`,key:n,content:`tab ${n} content`});return t}();const et=w.div`
  .custom-row {
...
`;var tt=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"custom-wrapper"},t.createElement(Xe,{className:"custom-row"},t.createElement(Ye,{fixedSpan:"12",className:"custom-col-sidebar"},"Sidebar"),t.createElement(Ye,{className:"custom-col-content"},t.createElement(Q,null,Ze.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))))));return t.createElement(et,null,e)}});const nt={};nt._basic=Y,nt["_custom-style"]=ne,nt["_disable-keyboard"]=oe,nt._closable=le,nt["_custom-tab"]=de,nt._disabled=be,nt["_editable-tab"]=he,nt["_excess-mode"]=Te,nt._extra=Ie,nt._nested=Me,nt["_lazy-load"]=Ke,nt._position=Pe,nt._size=je,nt._shape=Fe,nt["_trigger-type"]=Qe,nt["_tab-in-grid"]=tt;export default nt;
