import{r as e,aw as t,W as n}from"./index.d204dc79.js";import{q as l}from"./styled-components.browser.esm.b206912e.js";import{s as o}from"./solarlunar.min.cedb6bb7.js";function r(e){console.log(e.format("L"))}const a=l.div``;var c=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const l=e.exports.createElement("div",null,e.exports.createElement(t,{onSelect:r,defaultValue:n().add(1,"days")}));return e.exports.createElement(a,null,l)}});function s(e){console.log(e)}const d=l.div`
  .wrapped-calendar {
    width: 300px;
...
`;var b=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.exports.createElement(t,{dateCellRender:p,monthCellRender:f});return e.exports.createElement(x,null,n)}});function v(e){console.log(e.format("L"))}function _(e,t){console.log("Visible month changed to %s from <%s>",e.format("YYYY-MM"),t)}const g=l.div``;var E=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const l=e.exports.createElement(t,{onSelect:v,defaultVisibleMonth:()=>n("2018-01","YYYY-MM",!0),onVisibleMonthChange:_});return e.exports.createElement(g,null,l)}});const h=n(),y=function(e){return e.valueOf()>h.valueOf()};const S=l.div`
  .wrapped-calendar {
    width: 300px;
    border: 1px solid #c4c6cf;
    border-radius: 3px;
