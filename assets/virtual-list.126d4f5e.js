...
`;var m=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=d;return e.createElement(c,null,t)}});const p=[];function b(t){for(let i=0;i<t;i++)p.push((l=i)%3==0?e.createElement("li",{key:`key-${l}`,style:{lineHeight:"30px",background:"#5f83ff",color:"#fff"}},"key-",l):e.createElement("li",{key:`key-${l}`,style:{lineHeight:"20px"}},"key-",l));var l}class x extends e.Component{constructor(){super(...arguments),this.state={initial:20,dataSource:b(1e3)}}componentDidMount(){setTimeout((()=>{this.refs.virtual.getInstance().scrollTo(50)}),200)}getHeight(e){return e%3==0?30:20}onClick(){this.setState({initial:this.state.initial+20})}render(){return e.createElement("div",null,e.createElement("button",{onClick:this.onClick.bind(this)},"jump to ",this.state.initial+20),e.createElement("br",null),e.createElement("br",null),e.createElement("div",{className:"virtual-box"},e.createElement(t,{ref:"virtual",jumpIndex:this.state.initial,itemSizeGetter:this.getHeight.bind(this)},p)))}}const f=l.div`
  .virtual-box {
    height: 200px;
    width: 200px;
    border: 1px solid #ddd;
