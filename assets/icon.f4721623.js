import{r as e,b as t,v as n,a0 as o}from"./index.9e4b8ce1.js";import{q as r}from"./styled-components.browser.esm.19571eea.js";const l=r.div``;var i=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement("div",null,"button: ",e.createElement("br",null),e.createElement(t,{type:"atm",role:"button","aria-label":"icon atm",style:{margin:"5px"}}),e.createElement(t,{type:"smile",role:"button","aria-label":"icon smile",style:{margin:"5px"}}),e.createElement("br",null),"decoration: ",e.createElement("br",null),e.createElement(t,{type:"success","aria-hidden":!0,style:{margin:"5px"}}));return e.createElement(l,null,n)}});const a=r.div``;var c=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement(t,{type:"atm"});return e.createElement(a,null,n)}});const s=["xxs","xs","small","medium","large","xl","xxl","xxxl"];const p=r.div`
  .icon-sizes {
    margin: 0;
    padding: 0;
    list-style: none;
...
`;var f=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement("div",null,e.createElement("div",{className:"icon-list-2"},e.createElement(d,{type:"icon-store"}),e.createElement(d,{type:"icon-pic"}),e.createElement(d,{type:"icon-gift"})),e.createElement("br",null),e.createElement("ul",{className:"icon-sizes"},m.map(((t,n)=>e.createElement("li",{key:n},e.createElement(d,{type:"icon-pic",size:t}),e.createElement("span",null,t))))));return e.createElement(y,null,t)}});const g=r.div`
  .icon-style-demo {
    height: 24px;
    line-height: 24px;
    margin-bottom: 10px;
...
`;var k=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement("div",null,e.createElement("div",{className:"icon-list-title"},"Click on the icon to copy the code."),e.createElement("ul",{className:"icon-list"},w.map(((n,o)=>e.createElement(v,{key:o,text:`<Icon type="${n}" />`,onCopy:_},e.createElement("li",null,e.createElement(t,{type:n,size:"xl"}),e.createElement("span",null,n)))))),C.length?e.createElement("div",null,e.createElement("div",{className:"icon-list-custom-title"},"Custom Icon"),e.createElement("ul",{className:"icon-list"},C.map(((n,o)=>e.createElement(v,{key:o,text:`<Icon type="${n}" />`,onCopy:_},e.createElement("li",null,e.createElement(t,{type:n,size:"xl"}),e.createElement("span",null,n))))))):null);return e.createElement(O,null,n)}});const z={};z._accessibility=i,z._basic=c,z._size=u,z._iconfont=f,z._style=b,z._type=k;export default z;
