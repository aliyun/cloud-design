...
`;var J=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement("div",null,"LTR",t.createElement(i,{tip:"加载中..."},t.createElement("div",{className:"demo"},"test"))),t.createElement("div",null,"RTL",t.createElement(i,{tip:"加载中...",rtl:!0},t.createElement("div",{className:"demo"},"test"))));return t.createElement($,null,e)}});const Q=l.Item,X={labelCol:{fixedSpan:4},wrapperCol:{span:18}};class ee extends t.Component{constructor(e){super(e),this.state={visible:!1}}setVisible(e){this.setState({visible:e})}render(){return t.createElement("div",null,t.createElement(i,{visible:this.state.visible,shape:"fusion-reactor"},t.createElement(l,{style:{width:500}},t.createElement(Q,e({label:"Username"},X),t.createElement(s,null)),t.createElement(Q,e({label:"Password"},X),t.createElement(s,{htmlType:"password",placeholder:"please input"})),t.createElement(Q,e({label:"Detail"},X),t.createElement(s,{multiple:!0})))),t.createElement("div",{style:{paddingLeft:80}},t.createElement(c,{onClick:this.setVisible.bind(this,!0),type:"primary"},"Submit"),t.createElement(c,{onClick:this.setVisible.bind(this,!1),style:{marginLeft:5}},"Cancel")))}}const te=m.div``;var ne=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(ee,null);return t.createElement(te,null,e)}});const re=m.div`
  .demo {
    width: 500px;
    background-color: #f2f3f7;
    text-align: center;
...
`;var ie=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement(i,{tip:"default"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{tip:"right",tipAlign:"right"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{tip:"bottom",tipAlign:"bottom"},t.createElement("div",{className:"demo"},"test")));return t.createElement(oe,null,e)}});class le extends t.Component{constructor(e,t){super(e,t),this.onClose=()=>{this.setState({visible:!1})},this.state={visible:!1}}onClick(){this.setState({visible:!this.state.visible})}render(){return t.createElement("span",null,t.createElement(i,{visible:this.state.visible,fullScreen:!0,shape:"fusion-reactor",safeNode:this.btn,onVisibleChange:this.onClose.bind(this)},t.createElement(c,{onClick:this.onClick.bind(this),ref:e=>this.btn=e},"Full Screen")))}}const se=m.div``;var ce=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(le,null);return t.createElement(se,null,e)}});const ue=t.createElement("div",{className:"load-container load1"},t.createElement("div",{className:"loader"},"loading...")),de=t.createElement("div",{className:"load-container load7"},t.createElement("div",{className:"loader"},"loading..."));const fe=m.div`
  .demo {
    width: 500px;
    background-color: #f2f3f7;
    text-align: center;
...
`;var me=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement(i,{tip:"default animation"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{indicator:ue},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{indicator:de},t.createElement("div",{className:"demo"},"test")));return t.createElement(fe,null,e)}});var he=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:e=>t.createElement("div",null,t.createElement("div",{style:{width:400}},t.createElement(Z,{count:5})),t.createElement("p",null,"本骨架屏组件导出自",t.createElement("a",{href:"https://www.npmjs.com/package/react-loading-skeleton",target:"_blank"},"react-loading-skeleton"),"，更多用法请查阅它的文档。"))});const pe={};pe._basic=J,pe._state=ne,pe._size=ae,pe._tipAlign=ie,pe._fullscreen=ce,pe._indicator=me,pe._skeleton=he;export default pe;
