...
`;var j=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement(_,null);return e.createElement(k,null,t)}});const D=[{value:"2973",label:"陕西"}];class O extends e.Component{constructor(e){super(e),this.state={dataSource:D},this.onLoadData=this.onLoadData.bind(this)}onLoadData(e){return console.log(e),new Promise((e=>{setTimeout((()=>{this.setState({dataSource:[{value:"2973",label:"陕西",children:[{value:"2974",label:"西安",children:[{value:"2975",label:"西安市",isLeaf:!0},{value:"2976",label:"高陵县",isLeaf:!0}]},{value:"2980",label:"铜川",children:[{value:"2981",label:"铜川市",isLeaf:!0},{value:"2982",label:"宜君县",isLeaf:!0}]}]}]},e)}),500)}))}render(){return e.createElement(t,{style:{width:"302px"},dataSource:this.state.dataSource,loadData:this.onLoadData})}}const T=s.div``;var w=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement(O,null);return e.createElement(T,null,t)}});class M extends e.Component{constructor(e){super(e),this.state={value:[],data:[],multiple:!1},this.handleCheck=this.handleCheck.bind(this),this.handleChange=this.handleChange.bind(this)}componentDidMount(){fetch("https://os.alipayobjects.com/rmsportal/ODDwqcDFTLAguOvWEolX.json").then((e=>e.json())).then((e=>this.setState({data:e,value:["2975"]}))).catch((e=>console.log(e)))}handleCheck(){this.setState({multiple:!this.state.multiple,value:[]})}handleChange(e,t,l){console.log(e,t,l),this.setState({value:e})}render(){return e.createElement("div",{className:"search-demo"},e.createElement("label",{className:"multiple-check"},e.createElement(n,{value:this.state.multiple,onChange:this.handleCheck}),e.createElement("span",{className:"multiple-text"},"Multiple select")),e.createElement(t,{style:{width:"302px"},showSearch:!0,multiple:this.state.multiple,value:this.state.value,dataSource:this.state.data,onChange:this.handleChange}))}}const z=s.div`
...
`;var X=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement(F,null);return e.createElement(W,null,t)}});const R={};R._basic=h,R._accessibility=u,R._custom=p,R["_custom-style"]=S,R["_expand-trigger"]=x,R._multiple=j,R._dynamic=w,R._search=L,R["_multiple-control"]=A,R["_single-control"]=X;export default R;
