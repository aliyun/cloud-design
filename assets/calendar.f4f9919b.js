import{r as e,aw as t,W as n}from"./index.6a707a19.js";import{q as l}from"./styled-components.browser.esm.a87ca0b6.js";import{s as o}from"./solarlunar.min.82bc20f2.js";function r(e){console.log(e.format("L"))}const a=l.div``;var c=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const l=e.exports.createElement("div",null,e.exports.createElement(t,{onSelect:r,defaultValue:n().add(1,"days")}));return e.exports.createElement(a,null,l)}});function s(e){console.log(e)}const d=l.div`
  .wrapped-calendar {
    width: 300px;
