...
`;var pe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=t.createElement(Q,{shape:"wrapped",tabRender:(n,a)=>t.createElement(se,e({key:n},a))},le.map((n=>t.createElement(Q.Item,e(e({key:n.key},n),{tabStyle:{height:"60px"}}),n.desc))));return t.createElement(ce,null,n)}});const me=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var de=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Q,{disableKeyboard:!0},t.createElement(Q.Item,{title:"Home",key:"1"},"Home content"),t.createElement(Q.Item,{title:"Documentation",key:"2"},"Doc content"),t.createElement(Q.Item,{title:"Help",key:"3"},"Help Content"));return t.createElement(me,null,e)}});function ue(e){console.log(e)}const be=t.createElement(k,{type:"primary",onClick:function(){console.log("hello world")}},"Hello world");const fe=w.div`
  .fusion-demo .demo-item-title {
    font-size: 16px;
    color: #333;
    padding: 8px;
...
`;var ye=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},t.createElement("div",{className:"demo-item-title"},"Extra in Horizontal"),t.createElement(Q,{shape:"wrapped",onChange:ue,extra:be},t.createElement(Q.Item,{title:"Tab 1",key:"1"},"Tab 1 Content"),t.createElement(Q.Item,{title:"Tab 2",key:"2"},"Tab 2 Content"),t.createElement(Q.Item,{title:"Tab 3",key:"3"},"Tab 3 Content")),t.createElement("div",{className:"demo-item-title"},"Extra in Vertical"),t.createElement(Q,{shape:"wrapped",tabPosition:"left",onChange:ue,extra:be,contentClassName:"custom-tab-content"},t.createElement(Q.Item,{title:"Tab 1",key:"1"},"Tab 1 Content"),t.createElement(Q.Item,{title:"Tab 2",key:"2"},"Tab 2 Content"),t.createElement(Q.Item,{title:"Tab 3",key:"3"},"Tab 3 Content")));return t.createElement(fe,null,e)}});class ve extends t.Component{constructor(e){super(e),this.onKeyDown=e=>{const{keyCode:t}=e;t>36&&t<41&&e.stopPropagation()},this.onBlur=e=>{this.setState({editable:!1,tabTitle:e.target.value})},this.onDblClick=()=>{this.setState({editable:!0})},this.state={tabTitle:e.defaultTitle,editable:!1}}componentWillReceiveProps(e){e.defaultTitle!==this.state.tabTitle&&this.setState({tabTitle:e.defaultTitle})}render(){const{tabTitle:e,editable:n}=this.state;return n?t.createElement(T,{defaultValue:e,onKeyDown:this.onKeyDown,onBlur:this.onBlur}):t.createElement("span",{onDoubleClick:this.onDblClick},e)}}const he=(e,{title:n})=>t.createElement("div",{key:e,className:"editable-tab-wrapper"},t.createElement(ve,{defaultTitle:n}));const ge=w.div`
...
`;var Ee=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Q,{defaultActiveKey:"1",tabRender:he},t.createElement(Q.Item,{title:"Double Click To Edit Me",key:"1"},"Editable tab"),t.createElement(Q.Item,{title:"Double Click To Edit Me",key:"2"},"Editable tab"));return t.createElement(ge,null,e)}});const ke=[{tab:"Home",key:1},{tab:"Documnet",key:2},{tab:"Setting",key:3},{tab:"Help",key:4},{tab:"Admin",key:5},{tab:"More 1",key:6},{tab:"More 2",key:7},{tab:"More 3",key:8},{tab:"More 4",key:9},{tab:"More 5",key:10},{tab:"More 6",key:11},{tab:"More 7",key:12},{tab:"More 8",key:13},{tab:"More 9",key:14},{tab:"More 10",key:15},{tab:"More 11",key:16}];function Te(e){console.log(e)}const xe=w.div`
  .fusion-demo .demo-item-title {
    font-size: 16px;
    color: #333;
    padding: 8px;
...
`;var Ce=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo",style:{maxWidth:"520px"}},t.createElement("div",{className:"demo-item-title"},"Dropdown mode"),t.createElement(Q,{excessMode:"dropdown"},ke.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab,onClick:Te},e.tab," content, content, content")))),t.createElement("div",{className:"demo-item-title"},"Slide mode"),t.createElement(Q,{excessMode:"slide"},ke.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab,onClick:Te},e.tab," content, content, content")))));return t.createElement(xe,null,e)}});const we=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var Ie=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Q,null,t.createElement(Q.Item,{title:"Tab 1",disabled:!0,key:"1"},"Tab 1 content"),t.createElement(Q.Item,{title:"Tab 2",key:"2"},"Tab 2 content"),t.createElement(Q.Item,{title:"Tab 3",key:"3"},"Tab 3 content"));return t.createElement(we,null,e)}});const Ne=[{tab:"Home",key:0,content:"This is home page"},{tab:"Document",key:1,content:"This is document page"},{tab:"API",key:2,content:"This is api page"}];const _e=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var Me=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement("div",null,"Render all tab contents"),t.createElement(Q,{lazyLoad:!1},Ne.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("div",null,"Unmount inactive tabs"),t.createElement(Q,{unmountInactiveTabs:!0},Ne.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))));return t.createElement(_e,null,e)}});function Se(e){console.log(e)}const ze=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var Ke=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Q,{onChange:Se,shape:"wrapped"},t.createElement(Q.Item,{title:"Tab 1",key:"1"},t.createElement(Q,{shape:"wrapped"},t.createElement(Q.Item,{title:"1-1",key:"11"},"1-1"),t.createElement(Q.Item,{title:"1-2",key:"12"},"1-2"),t.createElement(Q.Item,{title:"1-3",key:"13"},"1-3"))),t.createElement(Q.Item,{title:"Tab 2",key:"2"},t.createElement(Q,{shape:"pure"},t.createElement(Q.Item,{title:"2-1",key:"21"},"2-1"),t.createElement(Q.Item,{title:"2-2",key:"22"},"2-2"),t.createElement(Q.Item,{title:"3-3",key:"23"},"2-3"))),t.createElement(Q.Item,{title:"Tab 3",key:"3"},t.createElement(Q,{shape:"capsule"},t.createElement(Q.Item,{title:"3-1",key:"31"},"3-1"),t.createElement(Q.Item,{title:"3-2",key:"32"},"3-2"),t.createElement(Q.Item,{title:"3-3",key:"33"},"3-3"))),t.createElement(Q.Item,{title:"Tab 4",key:"4"},t.createElement(Q,{shape:"text"},t.createElement(Q.Item,{title:"4-1",key:"41"},"4-1"),t.createElement(Q.Item,{title:"4-2",key:"42"},"4-2"),t.createElement(Q.Item,{title:"4-3",key:"43"},"4-3"))));return t.createElement(ze,null,e)}});function De(e){console.log(e)}const Oe=[{tab:"Home",key:"home",content:"This is home page"},{tab:"Document",key:"doc",content:"This is document page"},{tab:"API",key:"api",content:"This is api page"},{tab:"Repo",key:"repo",content:"This ia repo link"}],Pe=["pure","wrapped","text","capsule"];const Be=w.div`
  .fusion-demo-item {
    margin: 14px 0;
  }
...
`;var He=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},Pe.map((e=>t.createElement("div",{key:e,className:"fusion-demo-item"},t.createElement(Q,{shape:e,onChange:De},Oe.map((e=>t.createElement(Q.Item,{title:e.tab,key:e.key},e.content))))))));return t.createElement(Be,null,e)}});const je=[{tab:"Home",key:"home",content:"This is home page"},{tab:"Document",key:"doc",content:"This is document page"},{tab:"API",key:"api",content:"This is api page"}];const Re=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var Ae=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement(Q,{size:"small"},je.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("br",null),t.createElement(Q,{size:"small",shape:"wrapped"},je.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("br",null),t.createElement(Q,{size:"small",shape:"text"},je.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("br",null),t.createElement(Q,{size:"small",shape:"capsule"},je.map((e=>t.createElement(Q.TabPane,{key:e.key,title:e.tab},e.content)))));return t.createElement(Re,null,e)}});class Le extends t.Component{constructor(){super(...arguments),this.state={position:"top"},this.changePosition=e=>{this.setState({position:e})}}render(){return t.createElement("div",null,t.createElement(x,{onChange:this.changePosition,placeholder:"Choose Positon of Tab"},["top","bottom","left","right"].map((e=>t.createElement(x.Option,{value:e,key:e},e)))),t.createElement("br",null),t.createElement("br",null),t.createElement(Q,{tabPosition:this.state.position,shape:"wrapped",contentClassName:"custom-tab-content"},t.createElement(Q.Item,{title:"Tab 1",key:"1"},"Tab 1 Content"),t.createElement(Q.Item,{title:"Tab 2",key:"2"},"Tab 2 Content"),t.createElement(Q.Item,{title:"Tab 3",key:"3"},"Tab 3 Content")))}}const We=w.div`
  .custom-tab-content {
    min-height: 50px;
  }
...
`;var Fe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Le,null);return t.createElement(We,null,e)}});const{Row:Ue,Col:Ve}=C,$e=function(e){const t=[];for(let n=1;n<15;n++)t.push({tab:`tab ${n}`,key:n,content:`tab ${n} content`});return t}();const qe=w.div`
  .custom-row {
