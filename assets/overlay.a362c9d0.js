...
`;var _=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const l=e.createElement("div",null,e.createElement(x,{trigger:e.createElement(t,null,"Open"),triggerType:"click"},e.createElement("span",{className:"overlay-demo"},"Hello World From Popup!")),e.createElement("br",null),e.createElement("br",null),e.createElement(x,{trigger:e.createElement(r,{placeholder:"Use Down Arrow to open"}),triggerType:"click",triggerClickKeycode:40},e.createElement("span",{className:"overlay-demo"},"Hello World From Popup!")));return e.createElement(y,null,l)}});const{Popup:k}=l;const C=n.div`
  .overlay-demo {
    width: 300px;
    height: 100px;
    padding: 10px;
...
`;var S=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const l=e.createElement("div",null,e.createElement(k,{trigger:e.createElement(t,null,"click"),triggerType:"click"},e.createElement("span",{className:"overlay-demo"},"Click to open Popup!")),e.createElement(k,{trigger:e.createElement(t,null,"hover"),triggerType:"hover"},e.createElement("span",{className:"overlay-demo"},"Hover to open Popup!")),e.createElement(k,{trigger:e.createElement(t,null,"focus"),triggerType:"focus"},e.createElement("span",{className:"overlay-demo"},"Focus to open Popup!")));return e.createElement(C,null,l)}});const{Popup:N}=l;const T=n.div`
  .overlay-demo {
    width: 300px;
    height: 100px;
    padding: 10px;
...
`;var w=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const l=e.createElement("div",{className:"scroll-container"},e.createElement(N,{trigger:e.createElement(t,null,"Open"),triggerType:"click",container:e=>e.parentNode},e.createElement("div",{className:"overlay-demo"},"Hello World From Popup!")),e.createElement("div",{style:{height:"300px"}}));return e.createElement(T,null,l)}});const O={};O._backdrop=i,O._align=s,O._baisc=m,O._nested=b,O._controlled=E,O._popup=_,O["_trigger-type"]=S,O._scroll=w;export default O;
