import{r as e,ac as t,R as n}from"./index.353b20bd.js";import{q as l}from"./styled-components.browser.esm.78ec4042.js";const{Item:a,SubNav:o}=t,r=e.createElement("span",{className:"fusion"},"FUSION"),c=e.createElement("a",{className:"login-in",href:"javascript:;"},"Login in");const m=l.div`
  .basic-nav .fusion {
    margin: 8px 20px;
    width: 100px;
    color: #ffffff;
...
`;var i=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement(t,{className:"basic-nav",direction:"hoz",type:"primary",header:r,footer:c,defaultSelectedKeys:["home"],triggerType:"hover"},e.createElement(a,{key:"home"},"Home"),e.createElement(o,{label:"Component"},e.createElement(a,{key:"next"},"Next"),e.createElement(a,{key:"mext"},"Mext")),e.createElement(a,{key:"document"},"Document"));return e.createElement(m,null,n)}});const u=l.div``;var s=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement("div",null,"请查看"," ",e.createElement("a",{target:"_blank",rel:"noopener noreferrer",href:"https://codepen.io/aboutblank/pen/JjdNKrm"},"https://codepen.io/aboutblank/pen/JjdNKrm"));return e.createElement(u,null,t)}});const{Item:p,Group:d}=t;const E=l.div``;var v=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement(t,{style:{width:240}},e.createElement(d,{label:"Group Label 1"},e.createElement(p,{icon:"account"},"Navigation One"),e.createElement(p,{icon:"account"},"Navigation Two"),e.createElement(p,{icon:"account"},"Navigation Three")),e.createElement(d,{label:"Group Label 2"},e.createElement(p,{icon:"account"},"Navigation Four"),e.createElement(p,{icon:"account"},"Navigation Five"),e.createElement(p,{icon:"account"},"Navigation Six")));return e.createElement(E,null,n)}});const{Item:b,SubNav:h}=t;class g extends e.Component{constructor(){super(...arguments),this.state={popupAlign:"follow"}}setValue(e){this.setState({popupAlign:e})}render(){const{popupAlign:l}=this.state;return e.createElement("div",null,e.createElement("div",{className:"demo-ctl"},e.createElement(n.Group,{shape:"button",size:"medium",value:l,onChange:this.setValue.bind(this)},e.createElement(n,{value:"follow"},'popupAlign="follow"'),e.createElement(n,{value:"outside"},'popupAlign="outside"'))),e.createElement(t,{style:{height:400,width:240},mode:"popup",popupAlign:l,defaultOpenKeys:["sub-nav-2"]},e.createElement(h,{key:"sub-nav-1",label:"Sub Nav 1"},e.createElement(b,{key:"1"},"Item 1")),e.createElement(h,{key:"sub-nav-2",label:"Sub Nav 2"},e.createElement(b,{key:"1"},"Item 1"),e.createElement(b,{key:"2"},"Item 2")),e.createElement(h,{key:"sub-nav-3",label:"Sub Nav 3"},e.createElement(b,{key:"1"},"Item 1"),e.createElement(b,{key:"2"},"Item 2"),e.createElement(b,{key:"3"},"Item 3")),e.createElement(h,{key:"sub-nav-4",label:"Sub Nav 4"},e.createElement(b,{key:"1"},"Item 1"),e.createElement(b,{key:"2"},"Item 2"),e.createElement(b,{key:"3"},"Item 3"),e.createElement(b,{key:"4"},"Item 4"))))}}const f=l.div`
  .demo-ctl {
...
`;var A=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement(G,null);return e.createElement(j,null,t)}});const V={};V._basic=i,V._fixed=s,V._group=v,V["_popup-align"]=y,V["_open-mode"]=_,V._custom=O,V["_icon-only"]=A;export default V;
