...
`;var i=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement(a,null);return e.createElement(n,null,t)}});class r extends e.Component{constructor(e){super(e),this.state={visible:!0},this.handleToggle=this.handleToggle.bind(this)}handleToggle(){this.setState({visible:!this.state.visible})}render(){return e.createElement("div",null,e.createElement("button",{onClick:this.handleToggle},"Toggle visible"),e.createElement(t,{animation:{enter:"my-zoom-in",leave:"my-zoom-out"}},this.state.visible?e.createElement("div",{className:"basic-demo"},"Next Animate"):null))}}const l=o.div`
  .basic-demo {
    font-size: 96px;
    text-align: center;
  }
...
`;var d=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement(c,null);return e.createElement(m,null,t)}});const p={};p._expand=i,p._basic=s,p._multiple=d;export default p;
