import{r as e,N as t,m as n,a0 as o}from"./index.00e32565.js";import{q as r}from"./styled-components.browser.esm.b9987649.js";const l=r.div``;var i=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement(t,{type:"atm"});return e.createElement(l,null,n)}});const a=r.div``;var c=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement("div",null,"button: ",e.createElement("br",null),e.createElement(t,{type:"atm",role:"button","aria-label":"icon atm",style:{margin:"5px"}}),e.createElement(t,{type:"smile",role:"button","aria-label":"icon smile",style:{margin:"5px"}}),e.createElement("br",null),"decoration: ",e.createElement("br",null),e.createElement(t,{type:"success","aria-hidden":!0,style:{margin:"5px"}}));return e.createElement(a,null,n)}});const s=["xxs","xs","small","medium","large","xl","xxl","xxxl"];const p=r.div`
  .icon-sizes {
    margin: 0;
    padding: 0;
    list-style: none;
...
`;var u=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement("div",null,e.createElement("ul",{className:"icon-sizes"},s.map(((n,o)=>e.createElement("li",{key:o},e.createElement(t,{type:"smile",size:n}),e.createElement("span",null,n))))),e.createElement("span",null,"inherit"),e.createElement("h4",null,"Shall I compare thee to a summer's day?"," ",e.createElement(t,{type:"smile",size:"inherit"})," ",e.createElement(t,{type:"set",size:"inherit"})),e.createElement("h3",null,"Thou art more lovely and more temperate."," ",e.createElement(t,{type:"smile",size:"inherit"})," ",e.createElement(t,{type:"set",size:"inherit"})),e.createElement("h2",null,"Rough winds do shake the darling buds of May,"," ",e.createElement(t,{type:"smile",size:"inherit"})," ",e.createElement(t,{type:"set",size:"inherit"})),e.createElement("h1",null,"And summer's lease hath all too short a date."," ",e.createElement(t,{type:"smile",size:"inherit"})," ",e.createElement(t,{type:"set",size:"inherit"})));return e.createElement(p,null,n)}});const m=r.div`
  .icon-style-demo {
    height: 24px;
    line-height: 24px;
    margin-bottom: 10px;
...
`;var d=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement("div",null,e.createElement("div",{className:"icon-style-demo"},e.createElement(t,{type:"success",style:{color:"#1DC11D",marginRight:"10px"}}),"This is a success message!"),e.createElement("div",{className:"icon-style-demo"},e.createElement(t,{type:"warning",style:{color:"#FFA003",marginRight:"10px"}}),"This is a warning message!"),e.createElement("div",{className:"icon-style-demo"},e.createElement(t,{type:"error",style:{color:"#FF3333",marginRight:"10px"}}),"This is a failure message!"));return e.createElement(m,null,n)}});const y=["xxs","xs","small","medium","large","xl","xxl","xxxl"],f=t.createFromIconfontCN({scriptUrl:"//at.alicdn.com/t/font_1464085_egnk4s8yv2f.js"});const g=r.div`
  .icon-list-2 i {
    margin: 0 10px;
  }
  .icon-sizes {
...
`;var k=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement("div",null,e.createElement("div",{className:"icon-list-title"},"Click on the icon to copy the code."),e.createElement("ul",{className:"icon-list"},w.map(((n,o)=>e.createElement(v,{key:o,text:`<Icon type="${n}" />`,onCopy:_},e.createElement("li",null,e.createElement(t,{type:n,size:"xl"}),e.createElement("span",null,n)))))),C.length?e.createElement("div",null,e.createElement("div",{className:"icon-list-custom-title"},"Custom Icon"),e.createElement("ul",{className:"icon-list"},C.map(((n,o)=>e.createElement(v,{key:o,text:`<Icon type="${n}" />`,onCopy:_},e.createElement("li",null,e.createElement(t,{type:n,size:"xl"}),e.createElement("span",null,n))))))):null);return e.createElement(O,null,n)}});const z={};z._basic=i,z._accessibility=c,z._size=u,z._style=d,z._iconfont=b,z._type=k;export default z;
