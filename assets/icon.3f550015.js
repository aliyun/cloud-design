import{b as e,r as t,m as n,a0 as o}from"./index.9ecd65a8.js";import{q as r}from"./styled-components.browser.esm.fe3a3df0.js";const l=["xxs","xs","small","medium","large","xl","xxl","xxxl"],i=e.createFromIconfontCN({scriptUrl:"//at.alicdn.com/t/font_1464085_egnk4s8yv2f.js"});const a=r.div`
  .icon-list-2 i {
    margin: 0 10px;
  }
  .icon-sizes {
...
`;var _=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=t.createElement("div",null,t.createElement("div",{className:"icon-list-title"},"Click on the icon to copy the code."),t.createElement("ul",{className:"icon-list"},E.map(((n,o)=>t.createElement(x,{key:o,text:`<Icon type="${n}" />`,onCopy:w},t.createElement("li",null,t.createElement(e,{type:n,size:"xl"}),t.createElement("span",null,n)))))),v.length?t.createElement("div",null,t.createElement("div",{className:"icon-list-custom-title"},"Custom Icon"),t.createElement("ul",{className:"icon-list"},v.map(((n,o)=>t.createElement(x,{key:o,text:`<Icon type="${n}" />`,onCopy:w},t.createElement("li",null,t.createElement(e,{type:n,size:"xl"}),t.createElement("span",null,n))))))):null);return t.createElement(C,null,n)}});const O=r.div`
  .icon-style-demo {
    height: 24px;
    line-height: 24px;
    margin-bottom: 10px;
