...
`;var J=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement("div",null,"LTR",t.createElement(i,{tip:"加载中..."},t.createElement("div",{className:"demo"},"test"))),t.createElement("div",null,"RTL",t.createElement(i,{tip:"加载中...",rtl:!0},t.createElement("div",{className:"demo"},"test"))));return t.createElement($,null,e)}});class Q extends t.Component{constructor(e,t){super(e,t),this.onClose=()=>{this.setState({visible:!1})},this.state={visible:!1}}onClick(){this.setState({visible:!this.state.visible})}render(){return t.createElement("span",null,t.createElement(i,{visible:this.state.visible,fullScreen:!0,shape:"fusion-reactor",safeNode:this.btn,onVisibleChange:this.onClose.bind(this)},t.createElement(l,{onClick:this.onClick.bind(this),ref:e=>this.btn=e},"Full Screen")))}}const X=m.div``;var ee=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Q,null);return t.createElement(X,null,e)}});const te=t.createElement("div",{className:"load-container load1"},t.createElement("div",{className:"loader"},"loading...")),ne=t.createElement("div",{className:"load-container load7"},t.createElement("div",{className:"loader"},"loading..."));const re=m.div`
  .demo {
    width: 500px;
    background-color: #f2f3f7;
    text-align: center;
...
`;var ae=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement(i,{tip:"default animation"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{indicator:te},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{indicator:ne},t.createElement("div",{className:"demo"},"test")));return t.createElement(re,null,e)}});const oe=m.div`
  .demo {
    width: 500px;
    background-color: #f2f3f7;
    text-align: center;
...
`;var he=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement(i,{tip:"default"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{tip:"right",tipAlign:"right"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{tip:"bottom",tipAlign:"bottom"},t.createElement("div",{className:"demo"},"test")));return t.createElement(me,null,e)}});const pe={};pe._basic=J,pe._fullscreen=ee,pe._indicator=ae,pe._size=ie,pe._skeleton=le,pe._state=fe,pe._tipAlign=he;export default pe;
