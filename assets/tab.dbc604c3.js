...
`;var oe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},t.createElement("div",{className:"demo-item-title"},"Customize with contentStyle or contentClassName"),t.createElement(Q,{shape:"wrapped",contentStyle:ne},te.map((e=>t.createElement(Q.Item,{title:e.tab,key:e.key},e.tab)))),t.createElement("div",{className:"demo-item-title"},"Setting className and style in Tab.Item"),t.createElement(Q,{shape:"wrapped",navStyle:{background:"#DEE8FF"}},te.map((e=>t.createElement(Q.Item,{title:e.tab,key:e.key,className:"custom-tab-item",style:{background:"#FFF"}},e.tab)))),t.createElement("div",{className:"demo-item-title"},"Tabs with equal width"),t.createElement(Q,{shape:"capsule"},te.map((e=>t.createElement(Q.Item,{title:e.tab,key:e.key,className:"justify-tabs-tab"},e.tab)))));return t.createElement(ae,null,e)}});const ie=[{tab:"Mail",key:1,closeable:!1},{tab:"Message",key:2,closeable:!0},{tab:"Setting",key:3,closeable:!0},{tab:"Unread",key:4,closeable:!0}];class re extends t.Component{constructor(e){super(e),this.onClose=e=>{this.remove(e)},this.onChange=e=>{this.setState({activeKey:e})},this.addTabpane=()=>{this.setState((e=>{const{panes:t}=e;return t.push({tab:"new tab",key:Math.random(),closeable:!0}),{panes:t}}))},this.state={panes:ie,activeKey:ie[0].key}}remove(e){let t=this.state.activeKey;const n=[];this.state.panes.forEach((t=>{t.key!=e&&n.push(t)})),e==t&&(t=n[0].key),this.setState({panes:n,activeKey:t})}render(){const e=this.state;return t.createElement("div",null,t.createElement(k,{onClick:this.addTabpane,size:"large",type:"primary"},t.createElement(s,{type:"add"})," New Tab"),t.createElement(Q,{shape:"wrapped",activeKey:e.activeKey,onChange:this.onChange,onClose:this.onClose,className:"custom-tab"},e.panes.map((e=>t.createElement(Q.Item,{title:e.tab,key:e.key,closeable:e.closeable},e.tab," content")))))}}const se=w.div`
  .custom-tab {
    margin-top: 14px;
  }
...
`;var le=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(re,null);return t.createElement(se,null,e)}});class ce extends t.Component{constructor(e){super(e),this.onKeyDown=e=>{const{keyCode:t}=e;t>36&&t<41&&e.stopPropagation()},this.onBlur=e=>{this.setState({editable:!1,tabTitle:e.target.value})},this.onDblClick=()=>{this.setState({editable:!0})},this.state={tabTitle:e.defaultTitle,editable:!1}}componentWillReceiveProps(e){e.defaultTitle!==this.state.tabTitle&&this.setState({tabTitle:e.defaultTitle})}render(){const{tabTitle:e,editable:n}=this.state;return n?t.createElement(T,{defaultValue:e,onKeyDown:this.onKeyDown,onBlur:this.onBlur}):t.createElement("span",{onDoubleClick:this.onDblClick},e)}}const pe=(e,{title:n})=>t.createElement("div",{key:e,className:"editable-tab-wrapper"},t.createElement(ce,{defaultTitle:n}));const me=w.div`
...
`;var de=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Q,{defaultActiveKey:"1",tabRender:pe},t.createElement(Q.Item,{title:"Double Click To Edit Me",key:"1"},"Editable tab"),t.createElement(Q.Item,{title:"Double Click To Edit Me",key:"2"},"Editable tab"));return t.createElement(me,null,e)}});const ue=[{tab:"Home",key:1},{tab:"Documnet",key:2},{tab:"Setting",key:3},{tab:"Help",key:4},{tab:"Admin",key:5},{tab:"More 1",key:6},{tab:"More 2",key:7},{tab:"More 3",key:8},{tab:"More 4",key:9},{tab:"More 5",key:10},{tab:"More 6",key:11},{tab:"More 7",key:12},{tab:"More 8",key:13},{tab:"More 9",key:14},{tab:"More 10",key:15},{tab:"More 11",key:16}];function be(e){console.log(e)}const fe=w.div`
  .fusion-demo .demo-item-title {
    font-size: 16px;
    color: #333;
    padding: 8px;
...
`;var ye=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo",style:{maxWidth:"520px"}},t.createElement("div",{className:"demo-item-title"},"Dropdown mode"),t.createElement(Q,{excessMode:"dropdown"},ue.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab,onClick:be},e.tab," content, content, content")))),t.createElement("div",{className:"demo-item-title"},"Slide mode"),t.createElement(Q,{excessMode:"slide"},ue.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab,onClick:be},e.tab," content, content, content")))));return t.createElement(fe,null,e)}});function ve({title:e,desc:n}){return t.createElement("div",{className:"custom-tab-item"},t.createElement("div",{className:"tab-title"},e),t.createElement("div",{className:"tab-desc"},n))}const he=[{key:"e-checking",title:"Alipay",desc:"The fee to be paid is $15"},{key:"brand-card",title:"Bank Card",desc:"The fee to be paid is $17"}];const ge=w.div`
  .custom-tab-item {
    padding: 10px;
  }
...
`;var Ee=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=t.createElement(Q,{shape:"wrapped",tabRender:(n,a)=>t.createElement(ve,e({key:n},a))},he.map((n=>t.createElement(Q.Item,e(e({key:n.key},n),{tabStyle:{height:"60px"}}),n.desc))));return t.createElement(ge,null,n)}});const ke=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var Te=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Q,null,t.createElement(Q.Item,{title:"Tab 1",disabled:!0,key:"1"},"Tab 1 content"),t.createElement(Q.Item,{title:"Tab 2",key:"2"},"Tab 2 content"),t.createElement(Q.Item,{title:"Tab 3",key:"3"},"Tab 3 content"));return t.createElement(ke,null,e)}});const xe=[{tab:"Home",key:0,content:"This is home page"},{tab:"Document",key:1,content:"This is document page"},{tab:"API",key:2,content:"This is api page"}];const Ce=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var we=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement("div",null,"Render all tab contents"),t.createElement(Q,{lazyLoad:!1},xe.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("div",null,"Unmount inactive tabs"),t.createElement(Q,{unmountInactiveTabs:!0},xe.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))));return t.createElement(Ce,null,e)}});class Ie extends t.Component{constructor(){super(...arguments),this.state={position:"top"},this.changePosition=e=>{this.setState({position:e})}}render(){return t.createElement("div",null,t.createElement(x,{onChange:this.changePosition,placeholder:"Choose Positon of Tab"},["top","bottom","left","right"].map((e=>t.createElement(x.Option,{value:e,key:e},e)))),t.createElement("br",null),t.createElement("br",null),t.createElement(Q,{tabPosition:this.state.position,shape:"wrapped",contentClassName:"custom-tab-content"},t.createElement(Q.Item,{title:"Tab 1",key:"1"},"Tab 1 Content"),t.createElement(Q.Item,{title:"Tab 2",key:"2"},"Tab 2 Content"),t.createElement(Q.Item,{title:"Tab 3",key:"3"},"Tab 3 Content")))}}const Ne=w.div`
  .custom-tab-content {
    min-height: 50px;
  }
...
`;var _e=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Ie,null);return t.createElement(Ne,null,e)}});function Me(e){console.log(e)}const Se=[{tab:"Home",key:"home",content:"This is home page"},{tab:"Document",key:"doc",content:"This is document page"},{tab:"API",key:"api",content:"This is api page"},{tab:"Repo",key:"repo",content:"This ia repo link"}],ze=["pure","wrapped","text","capsule"];const Ke=w.div`
  .fusion-demo-item {
    margin: 14px 0;
  }
...
`;var De=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},ze.map((e=>t.createElement("div",{key:e,className:"fusion-demo-item"},t.createElement(Q,{shape:e,onChange:Me},Se.map((e=>t.createElement(Q.Item,{title:e.tab,key:e.key},e.content))))))));return t.createElement(Ke,null,e)}});const Oe=[{tab:"Home",key:"home",content:"This is home page"},{tab:"Document",key:"doc",content:"This is document page"},{tab:"API",key:"api",content:"This is api page"}];const Pe=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var Be=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement(Q,{size:"small"},Oe.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("br",null),t.createElement(Q,{size:"small",shape:"wrapped"},Oe.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("br",null),t.createElement(Q,{size:"small",shape:"text"},Oe.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("br",null),t.createElement(Q,{size:"small",shape:"capsule"},Oe.map((e=>t.createElement(Q.TabPane,{key:e.key,title:e.tab},e.content)))));return t.createElement(Pe,null,e)}});const He=[{tab:"Home",key:0,content:"This is home page"},{tab:"Document",key:1,content:"This is document page"},{tab:"API",key:2,content:"This is api page"}];function je(e){console.log("change",e)}function Re(e){console.log("click",e)}function Ae(e,t){console.log("enter",t.target,e)}function Le(e,t){console.log("leave",t.target,e)}const We=w.div`
  .fusion-demo .demo-item-title {
    font-size: 16px;
    color: #333;
    padding: 8px;
...
`;var Fe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},t.createElement("div",{className:"demo-item-title"},"Click to trigger change"),t.createElement(Q,{triggerType:"click",onChange:je},He.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab,onClick:Re},e.content)))),t.createElement("div",{className:"demo-item-title"},"Hover to trigger change"),t.createElement(Q,{triggerType:"hover",onChange:je},He.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab,onClick:Re,onMouseEnter:Ae,onMouseLeave:Le},e.content)))));return t.createElement(We,null,e)}});function Ue(e){console.log(e)}const Ve=t.createElement(k,{type:"primary",onClick:function(){console.log("hello world")}},"Hello world");const $e=w.div`
  .fusion-demo .demo-item-title {
    font-size: 16px;
    color: #333;
    padding: 8px;
...
`;var qe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},t.createElement("div",{className:"demo-item-title"},"Extra in Horizontal"),t.createElement(Q,{shape:"wrapped",onChange:Ue,extra:Ve},t.createElement(Q.Item,{title:"Tab 1",key:"1"},"Tab 1 Content"),t.createElement(Q.Item,{title:"Tab 2",key:"2"},"Tab 2 Content"),t.createElement(Q.Item,{title:"Tab 3",key:"3"},"Tab 3 Content")),t.createElement("div",{className:"demo-item-title"},"Extra in Vertical"),t.createElement(Q,{shape:"wrapped",tabPosition:"left",onChange:Ue,extra:Ve,contentClassName:"custom-tab-content"},t.createElement(Q.Item,{title:"Tab 1",key:"1"},"Tab 1 Content"),t.createElement(Q.Item,{title:"Tab 2",key:"2"},"Tab 2 Content"),t.createElement(Q.Item,{title:"Tab 3",key:"3"},"Tab 3 Content")));return t.createElement($e,null,e)}});function Ge(e){console.log(e)}const Je=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var Qe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Q,{onChange:Ge,shape:"wrapped"},t.createElement(Q.Item,{title:"Tab 1",key:"1"},t.createElement(Q,{shape:"wrapped"},t.createElement(Q.Item,{title:"1-1",key:"11"},"1-1"),t.createElement(Q.Item,{title:"1-2",key:"12"},"1-2"),t.createElement(Q.Item,{title:"1-3",key:"13"},"1-3"))),t.createElement(Q.Item,{title:"Tab 2",key:"2"},t.createElement(Q,{shape:"pure"},t.createElement(Q.Item,{title:"2-1",key:"21"},"2-1"),t.createElement(Q.Item,{title:"2-2",key:"22"},"2-2"),t.createElement(Q.Item,{title:"3-3",key:"23"},"2-3"))),t.createElement(Q.Item,{title:"Tab 3",key:"3"},t.createElement(Q,{shape:"capsule"},t.createElement(Q.Item,{title:"3-1",key:"31"},"3-1"),t.createElement(Q.Item,{title:"3-2",key:"32"},"3-2"),t.createElement(Q.Item,{title:"3-3",key:"33"},"3-3"))),t.createElement(Q.Item,{title:"Tab 4",key:"4"},t.createElement(Q,{shape:"text"},t.createElement(Q.Item,{title:"4-1",key:"41"},"4-1"),t.createElement(Q.Item,{title:"4-2",key:"42"},"4-2"),t.createElement(Q.Item,{title:"4-3",key:"43"},"4-3"))));return t.createElement(Je,null,e)}});const{Row:Xe,Col:Ye}=C,Ze=function(e){const t=[];for(let n=1;n<15;n++)t.push({tab:`tab ${n}`,key:n,content:`tab ${n} content`});return t}();const et=w.div`
  .custom-row {
...
`;var tt=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"custom-wrapper"},t.createElement(Xe,{className:"custom-row"},t.createElement(Ye,{fixedSpan:"12",className:"custom-col-sidebar"},"Sidebar"),t.createElement(Ye,{className:"custom-col-content"},t.createElement(Q,null,Ze.map((e=>t.createElement(Q.Item,{key:e.key,title:e.tab},e.content)))))));return t.createElement(et,null,e)}});const nt={};nt._basic=Y,nt["_disable-keyboard"]=ee,nt["_custom-style"]=oe,nt._closable=le,nt["_editable-tab"]=de,nt["_excess-mode"]=ye,nt["_custom-tab"]=Ee,nt._disabled=Te,nt["_lazy-load"]=we,nt._position=_e,nt._shape=De,nt._size=Be,nt["_trigger-type"]=Fe,nt._extra=qe,nt._nested=Qe,nt["_tab-in-grid"]=tt;export default nt;
