import{r as e,b as t,B as a}from"./index.4272a92a.js";import{q as n}from"./styled-components.browser.esm.6c715b82.js";import{N as l}from"./index.3bb847cc.js";const r=n.div`
  .basic-example {
...
`;var s=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const a=e.createElement("div",null,e.createElement(l,{content:"hot",style:{backgroundColor:"#C82727",color:"#FFFFFF"}},e.createElement("a",{href:"#",className:"head-example"})),e.createElement(l,{content:e.createElement(t,{type:"error"}),style:{backgroundColor:"transparent",color:"#C82727",padding:0}},e.createElement("a",{href:"#",className:"head-example"})));return e.createElement(o,null,a)}});const i=n.div`
  .next-badge {
    margin-right: 16px;
  }
...
`;var x=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement(E,null);return e.createElement(b,null,t)}});const f={};f._basic=c,f._content=s,f._dot=m,f["_no-wrapper"]=u,f._plus=p,f._change=x;export default f;
