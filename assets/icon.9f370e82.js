import{r as e,b as t,m as n,a0 as o}from"./index.4272a92a.js";import{q as r}from"./styled-components.browser.esm.6c715b82.js";const l=r.div``;var i=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement("div",null,"button: ",e.createElement("br",null),e.createElement(t,{type:"atm",role:"button","aria-label":"icon atm",style:{margin:"5px"}}),e.createElement(t,{type:"smile",role:"button","aria-label":"icon smile",style:{margin:"5px"}}),e.createElement("br",null),"decoration: ",e.createElement("br",null),e.createElement(t,{type:"success","aria-hidden":!0,style:{margin:"5px"}}));return e.createElement(l,null,n)}});const a=["xxs","xs","small","medium","large","xl","xxl","xxxl"],c=t.createFromIconfontCN({scriptUrl:"//at.alicdn.com/t/font_1464085_egnk4s8yv2f.js"});const s=r.div`
  .icon-list-2 i {
    margin: 0 10px;
  }
  .icon-sizes {
...
`;var k=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement("div",null,e.createElement("div",{className:"icon-list-title"},"Click on the icon to copy the code."),e.createElement("ul",{className:"icon-list"},w.map(((n,o)=>e.createElement(v,{key:o,text:`<Icon type="${n}" />`,onCopy:_},e.createElement("li",null,e.createElement(t,{type:n,size:"xl"}),e.createElement("span",null,n)))))),C.length?e.createElement("div",null,e.createElement("div",{className:"icon-list-custom-title"},"Custom Icon"),e.createElement("ul",{className:"icon-list"},C.map(((n,o)=>e.createElement(v,{key:o,text:`<Icon type="${n}" />`,onCopy:_},e.createElement("li",null,e.createElement(t,{type:n,size:"xl"}),e.createElement("span",null,n))))))):null);return e.createElement(O,null,n)}});const z={};z._accessibility=i,z._iconfont=p,z._style=m,z._basic=y,z._size=b,z._type=k;export default z;
