import{r as e,b as t,B as a}from"./index.4543a34a.js";import{q as n}from"./styled-components.browser.esm.09d3b94c.js";import{N as l}from"./index.5f7fe586.js";const r=n.div`
  .basic-example {
...
`;var u=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const a=e.createElement("div",null,e.createElement(l,{dot:!0},e.createElement(t,{type:"email"})),e.createElement(l,{count:0,dot:!0},e.createElement(t,{type:"email"})),e.createElement(l,{dot:!0},e.createElement("a",{href:"#"},"A Link")));return e.createElement(d,null,a)}});const h=n.div`
  .next-badge {
    margin-right: 24px;
  }
  .head-example {
...
`;var p=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const a=e.createElement("div",null,e.createElement(l,{content:"hot",style:{backgroundColor:"#FC0E3D",color:"#FFFFFF"}},e.createElement("a",{href:"#",className:"head-example"})),e.createElement(l,{content:e.createElement(t,{type:"error"}),style:{backgroundColor:"transparent",color:"red",padding:0}},e.createElement("a",{href:"#",className:"head-example"})));return e.createElement(h,null,a)}});const E=n.div`
  .next-badge {
    margin-right: 16px;
  }
  .head-example {
...
`;var v=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement("div",null,e.createElement(l,{count:25}),e.createElement(l,{count:4,style:{backgroundColor:"#fff",color:"#999",border:"1px solid #d9d9d9"}}),e.createElement(l,{count:109,style:{backgroundColor:"#87d068"}}),e.createElement(l,{dot:!0}),e.createElement(l,{content:"hot",style:{backgroundColor:"#FC0E3D",color:"#FFFFFF"}}));return e.createElement(y,null,t)}});const k={};k._accessibility=c,k._clickable=s,k._basic=m,k._dot=u,k._content=p,k._overflowCount=b,k["_dynamic-content"]=_,k["_no-wrapper"]=v;export default k;
