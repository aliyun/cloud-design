import{r as e,b as t,m as n,a0 as o}from"./index.3d842b9a.js";import{q as r}from"./styled-components.browser.esm.b64bc59a.js";const l=r.div``;var i=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement("div",null,"button: ",e.createElement("br",null),e.createElement(t,{type:"atm",role:"button","aria-label":"icon atm",style:{margin:"5px"}}),e.createElement(t,{type:"smile",role:"button","aria-label":"icon smile",style:{margin:"5px"}}),e.createElement("br",null),"decoration: ",e.createElement("br",null),e.createElement(t,{type:"success","aria-hidden":!0,style:{margin:"5px"}}));return e.createElement(l,null,n)}});const a=["xxs","xs","small","medium","large","xl","xxl","xxxl"],c=t.createFromIconfontCN({scriptUrl:"//at.alicdn.com/t/font_1464085_egnk4s8yv2f.js"});const s=r.div`
  .icon-list-2 i {
    margin: 0 10px;
  }
  .icon-sizes {
...
`;var p=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement("div",null,e.createElement("div",{className:"icon-list-2"},e.createElement(c,{type:"icon-store"}),e.createElement(c,{type:"icon-pic"}),e.createElement(c,{type:"icon-gift"})),e.createElement("br",null),e.createElement("ul",{className:"icon-sizes"},a.map(((t,n)=>e.createElement("li",{key:n},e.createElement(c,{type:"icon-pic",size:t}),e.createElement("span",null,t))))));return e.createElement(s,null,t)}});const u=r.div``;var m=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement(t,{type:"atm"});return e.createElement(u,null,n)}});const d=["xxs","xs","small","medium","large","xl","xxl","xxxl"];const y=r.div`
  .icon-sizes {
    margin: 0;
    padding: 0;
    list-style: none;
...
`;var _=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement("div",null,e.createElement("div",{className:"icon-list-title"},"Click on the icon to copy the code."),e.createElement("ul",{className:"icon-list"},E.map(((n,o)=>e.createElement(x,{key:o,text:`<Icon type="${n}" />`,onCopy:w},e.createElement("li",null,e.createElement(t,{type:n,size:"xl"}),e.createElement("span",null,n)))))),v.length?e.createElement("div",null,e.createElement("div",{className:"icon-list-custom-title"},"Custom Icon"),e.createElement("ul",{className:"icon-list"},v.map(((n,o)=>e.createElement(x,{key:o,text:`<Icon type="${n}" />`,onCopy:w},e.createElement("li",null,e.createElement(t,{type:n,size:"xl"}),e.createElement("span",null,n))))))):null);return e.createElement(C,null,n)}});const O=r.div`
  .icon-style-demo {
    height: 24px;
    line-height: 24px;
    margin-bottom: 10px;
