...
`;var J=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement("div",null,"LTR",t.createElement(i,{tip:"加载中..."},t.createElement("div",{className:"demo"},"test"))),t.createElement("div",null,"RTL",t.createElement(i,{tip:"加载中...",rtl:!0},t.createElement("div",{className:"demo"},"test"))));return t.createElement($,null,e)}});class Q extends t.Component{constructor(e,t){super(e,t),this.onClose=()=>{this.setState({visible:!1})},this.state={visible:!1}}onClick(){this.setState({visible:!this.state.visible})}render(){return t.createElement("span",null,t.createElement(i,{visible:this.state.visible,fullScreen:!0,shape:"fusion-reactor",safeNode:this.btn,onVisibleChange:this.onClose.bind(this)},t.createElement(l,{onClick:this.onClick.bind(this),ref:e=>this.btn=e},"Full Screen")))}}const X=m.div``;var ee=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Q,null);return t.createElement(X,null,e)}});const te=m.div`
  .demo {
    width: 500px;
    background-color: #f2f3f7;
    text-align: center;
...
`;var ne=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement(i,{tip:"normal(size default large)"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{tip:"large",size:"large"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{tip:"medium",size:"medium"},t.createElement("div",{className:"demo"},"test")));return t.createElement(te,null,e)}});const re=m.div`
  .demo {
    width: 500px;
    background-color: #f2f3f7;
    text-align: center;
...
`;var ae=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement(i,{tip:"default"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{tip:"right",tipAlign:"right"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{tip:"bottom",tipAlign:"bottom"},t.createElement("div",{className:"demo"},"test")));return t.createElement(re,null,e)}});var oe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:e=>t.createElement("div",null,t.createElement("div",{style:{width:400}},t.createElement(Z,{count:5})),t.createElement("p",null,"本骨架屏组件导出自",t.createElement("a",{href:"https://www.npmjs.com/package/react-loading-skeleton",target:"_blank"},"react-loading-skeleton"),"，更多用法请查阅它的文档。"))});const ie=t.createElement("div",{className:"load-container load1"},t.createElement("div",{className:"loader"},"loading...")),le=t.createElement("div",{className:"load-container load7"},t.createElement("div",{className:"loader"},"loading..."));const se=m.div`
  .demo {
    width: 500px;
    background-color: #f2f3f7;
    text-align: center;
...
`;var ce=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement(i,{tip:"default animation"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{indicator:ie},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{indicator:le},t.createElement("div",{className:"demo"},"test")));return t.createElement(se,null,e)}});const ue=s.Item,de={labelCol:{fixedSpan:4},wrapperCol:{span:18}};class fe extends t.Component{constructor(e){super(e),this.state={visible:!1}}setVisible(e){this.setState({visible:e})}render(){return t.createElement("div",null,t.createElement(i,{visible:this.state.visible,shape:"fusion-reactor"},t.createElement(s,{style:{width:500}},t.createElement(ue,e({label:"Username"},de),t.createElement(c,null)),t.createElement(ue,e({label:"Password"},de),t.createElement(c,{htmlType:"password",placeholder:"please input"})),t.createElement(ue,e({label:"Detail"},de),t.createElement(c,{multiple:!0})))),t.createElement("div",{style:{paddingLeft:80}},t.createElement(l,{onClick:this.setVisible.bind(this,!0),type:"primary"},"Submit"),t.createElement(l,{onClick:this.setVisible.bind(this,!1),style:{marginLeft:5}},"Cancel")))}}const me=m.div``;var he=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(fe,null);return t.createElement(me,null,e)}});const pe={};pe._basic=J,pe._fullscreen=ee,pe._size=ne,pe._tipAlign=ae,pe._skeleton=oe,pe._indicator=ce,pe._state=he;export default pe;
