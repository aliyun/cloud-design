import{r as e,b as t,m as n,a0 as o}from"./index.3c24fdbb.js";import{q as r}from"./styled-components.browser.esm.1222bcc8.js";const l=r.div``;var i=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement(t,{type:"atm"});return e.createElement(l,null,n)}});const a=["xxs","xs","small","medium","large","xl","xxl","xxxl"],c=t.createFromIconfontCN({scriptUrl:"//at.alicdn.com/t/font_1464085_egnk4s8yv2f.js"});const s=r.div`
  .icon-list-2 i {
    margin: 0 10px;
  }
  .icon-sizes {
