import{r as e,N as t}from"./index.6a707a19.js";import{q as l}from"./styled-components.browser.esm.a87ca0b6.js";const i=[],r=(t="index")=>t%3==0?e.exports.createElement("li",{key:`key-${t}`,style:{lineHeight:"30px",background:"#5f83ff",color:"#fff"}},"key-",t):e.exports.createElement("li",{key:`key-${t}`,style:{lineHeight:"20px"}},"key-",t);for(let v=0;v<1e3;v++)i.push(r(v));const o=e.exports.createElement("div",{className:"virtual-box"},e.exports.createElement(t,null,i));const n=l.div`
  .virtual-box {
    height: 200px;
    width: 200px;
