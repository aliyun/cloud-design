import{b as e,r as t,m as n,a0 as o}from"./index.4497680a.js";import{q as r}from"./styled-components.browser.esm.86ed65a5.js";const l=["xxs","xs","small","medium","large","xl","xxl","xxxl"],i=e.createFromIconfontCN({scriptUrl:"//at.alicdn.com/t/font_1464085_egnk4s8yv2f.js"});const a=r.div`
  .icon-list-2 i {
    margin: 0 10px;
  }
  .icon-sizes {
...
`;var d=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=t.createElement("div",null,t.createElement("ul",{className:"icon-sizes"},u.map(((n,o)=>t.createElement("li",{key:o},t.createElement(e,{type:"smile",size:n}),t.createElement("span",null,n))))),t.createElement("span",null,"inherit"),t.createElement("h4",null,"Shall I compare thee to a summer's day?"," ",t.createElement(e,{type:"smile",size:"inherit"})," ",t.createElement(e,{type:"set",size:"inherit"})),t.createElement("h3",null,"Thou art more lovely and more temperate."," ",t.createElement(e,{type:"smile",size:"inherit"})," ",t.createElement(e,{type:"set",size:"inherit"})),t.createElement("h2",null,"Rough winds do shake the darling buds of May,"," ",t.createElement(e,{type:"smile",size:"inherit"})," ",t.createElement(e,{type:"set",size:"inherit"})),t.createElement("h1",null,"And summer's lease hath all too short a date."," ",t.createElement(e,{type:"smile",size:"inherit"})," ",t.createElement(e,{type:"set",size:"inherit"})));return t.createElement(m,null,n)}});const y=r.div``;var f=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=t.createElement(e,{type:"atm"});return t.createElement(y,null,n)}});const g=r.div`
  .icon-style-demo {
    height: 24px;
    line-height: 24px;
    margin-bottom: 10px;
...
`;var k=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=t.createElement("div",null,t.createElement("div",{className:"icon-list-title"},"Click on the icon to copy the code."),t.createElement("ul",{className:"icon-list"},w.map(((n,o)=>t.createElement(v,{key:o,text:`<Icon type="${n}" />`,onCopy:_},t.createElement("li",null,t.createElement(e,{type:n,size:"xl"}),t.createElement("span",null,n)))))),C.length?t.createElement("div",null,t.createElement("div",{className:"icon-list-custom-title"},"Custom Icon"),t.createElement("ul",{className:"icon-list"},C.map(((n,o)=>t.createElement(v,{key:o,text:`<Icon type="${n}" />`,onCopy:_},t.createElement("li",null,t.createElement(e,{type:n,size:"xl"}),t.createElement("span",null,n))))))):null);return t.createElement(O,null,n)}});const z={};z._iconfont=c,z._accessibility=p,z._size=d,z._basic=f,z._style=b,z._type=k;export default z;
