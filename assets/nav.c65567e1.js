import{r as e,ae as t,a5 as o,a7 as r}from"./index.672a70f3.js";import{q as n}from"./styled-components.browser.esm.f3e9ec77.js";const{Item:l,SubNav:a}=t,c=e.exports.createElement("span",{className:"fusion"},"FUSION"),s=e.exports.createElement("a",{className:"login-in",href:"javascript:;"},"Login in");const p=n.div`
  .basic-nav .fusion {
    margin: 8px 20px;
    width: 100px;
    color: #ffffff;
...
`;var m=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const o=e.exports.createElement(t,{className:"basic-nav",mode:"popup",direction:"hoz",type:"primary",header:c,footer:s,defaultSelectedKeys:["home"],triggerType:"hover"},e.exports.createElement(l,{key:"home"},"Home"),e.exports.createElement(a,{label:"Component",noIcon:!0},e.exports.createElement(a,{label:"Next"},e.exports.createElement(l,{key:"next-design"},"Design"),e.exports.createElement(l,{key:"next-doc"},"Document")),e.exports.createElement(a,{label:"Meet"},e.exports.createElement(l,{key:"meet-design"},"Design"),e.exports.createElement(l,{key:"meet-doc"},"Document"))),e.exports.createElement(l,{key:"document"},"Document"));return e.exports.createElement(p,null,o)}});const{Item:i,SubNav:u}=t;class x extends e.exports.Component{constructor(){super(...arguments),this.state={type:"normal",direction:"hoz",activeDirection:null,triggerType:"click",mode:"inline"}}setValue(e,t){this.setState({[e]:""===t?null:t})}setTriggerType(e){this.setState({triggerType:e})}setModeType(e){this.setState({mode:e})}render(){const{type:r,direction:n,activeDirection:l,triggerType:a,mode:c}=this.state;return e.exports.createElement("div",null,e.exports.createElement("div",{className:"demo-ctl"},e.exports.createElement(o.Group,{shape:"button",size:"medium",value:r,onChange:this.setValue.bind(this,"type")},e.exports.createElement(o,{value:"normal"},'type="normal"'),e.exports.createElement(o,{value:"primary"},'type="primary"'),e.exports.createElement(o,{value:"secondary"},'type="secondary"'),e.exports.createElement(o,{value:"line"},'type="line"')),e.exports.createElement(o.Group,{shape:"button",size:"medium",value:n,onChange:this.setValue.bind(this,"direction")},e.exports.createElement(o,{value:"hoz"},'direction="hoz"'),e.exports.createElement(o,{value:"ver"},'direction="ver"')),e.exports.createElement(o.Group,{shape:"button",size:"medium",value:null===l?"":l,onChange:this.setValue.bind(this,"activeDirection")},e.exports.createElement(o,{value:""},"activeDirection=null"),"hoz"===n?e.exports.createElement(o,{value:"top"},'activeDirection="top"'):null,"hoz"===n?e.exports.createElement(o,{value:"bottom"},'activeDirection="bottom"'):null,"ver"===n?e.exports.createElement(o,{value:"left"},'activeDirection="left"'):null,"ver"===n?e.exports.createElement(o,{value:"right"},'activeDirection="right"'):null),e.exports.createElement(o.Group,{shape:"button",size:"medium",value:a,onChange:this.setTriggerType.bind(this)},e.exports.createElement(o,{value:"click"},'triggerType="click"'),e.exports.createElement(o,{value:"hover"},'triggerType="hover"')),e.exports.createElement(o.Group,{shape:"button",size:"medium",value:c,onChange:this.setModeType.bind(this)},e.exports.createElement(o,{value:"inline"},'mode="inline"'),e.exports.createElement(o,{value:"popup"},'mode="popup"'))),e.exports.createElement(t,{className:"custom-nav",mode:c,type:r,direction:n,activeDirection:l,triggerType:a},e.exports.createElement(i,null,"Item 1"),e.exports.createElement(i,null,"Item 2"),e.exports.createElement(u,{label:"Sub Nav"},e.exports.createElement(i,null,"Item 3"),e.exports.createElement(i,null,"Item 4"),e.exports.createElement(u,{label:"Sub Nav"},e.exports.createElement(i,null,"Item 5"),e.exports.createElement(i,null,"Item 6"))),e.exports.createElement(i,{icon:"account"},e.exports.createElement("a",{href:"http://www.taobao.com",target:"_blank"},"Taobao"))))}}const d=n.div`
  .demo-ctl {
...
`;var D=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.exports.createElement(G,null);return e.exports.createElement(j,null,t)}});const{Item:V,SubNav:F}=t;class K extends e.exports.Component{constructor(){super(...arguments),this.state={collapse:!1,embeddable:!1},this.onChange=e=>{this.setState({collapse:e})},this.changeEmbeddable=e=>{this.setState({embeddable:e})}}render(){const{collapse:n,embeddable:l}=this.state;let a,c;return n?(a=!0,c="popup"):(a=!1,c="inline"),e.exports.createElement("div",null,e.exports.createElement(r,{defaultChecked:!1,onChange:this.onChange,size:"small"}),e.exports.createElement("div",{className:"demo-ctl"},e.exports.createElement(o.Group,{shape:"button",size:"medium",value:l,onChange:this.changeEmbeddable},e.exports.createElement(o,{value:!0},"embeddable=true"),e.exports.createElement(o,{value:!1},"embeddable=false"))),e.exports.createElement(t,{style:{width:"200px"},embeddable:l,defaultOpenAll:!0,defaultSelectedKeys:["0-1"],iconOnly:a,hasArrow:!1,hasTooltip:!0,mode:c},e.exports.createElement(V,{icon:"calendar"}," Schedule "),e.exports.createElement(V,{icon:"email"}," Email "),e.exports.createElement(V,{icon:"help"}," Help "),e.exports.createElement(F,{icon:"set",label:"Settings"},e.exports.createElement(V,{icon:"account"}," Account "),e.exports.createElement(V,{icon:"exit"}," Exit "))))}}const L=n.div`
  .demo-ctl {
    background-color: #f1f1f1;
    border-left: 4px solid #0d599a;
    color: #0a7ac3;
