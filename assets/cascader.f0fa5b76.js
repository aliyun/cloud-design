import{r as e,L as t,R as a,M as l}from"./index.353b20bd.js";import{q as n}from"./styled-components.browser.esm.78ec4042.js";import"./fetch.71669c70.js";const o=[{value:"2973",label:"陕西"}];class s extends e.Component{constructor(e){super(e),this.state={dataSource:o},this.onLoadData=this.onLoadData.bind(this)}onLoadData(e){return console.log(e),new Promise((e=>{setTimeout((()=>{this.setState({dataSource:[{value:"2973",label:"陕西",children:[{value:"2974",label:"西安",children:[{value:"2975",label:"西安市",isLeaf:!0},{value:"2976",label:"高陵县",isLeaf:!0}]},{value:"2980",label:"铜川",children:[{value:"2981",label:"铜川市",isLeaf:!0},{value:"2982",label:"宜君县",isLeaf:!0}]}]}]},e)}),500)}))}render(){return e.createElement(t,{canOnlySelectLeaf:!0,dataSource:this.state.dataSource,loadData:this.onLoadData})}}const c=n.div`
  .cascader-value {
    margin-bottom: 10px;
    font-size: 14px;
    color: #666;
...
`;var z=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement(j,null);return e.createElement(O,null,t)}});const M={};M._dynamic=r,M._basic=d,M["_custom-style"]=g,M["_expand-trigger"]=f,M["_multiple-control"]=C,M._multiple=_,M._source=T,M["_single-control"]=z;export default M;
