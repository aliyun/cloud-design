...
`;var re=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},t.createElement("div",{className:"demo-item-title"},"Customize with contentStyle or contentClassName"),t.createElement(Z,{shape:"wrapped",contentStyle:oe},ae.map((e=>t.createElement(Z.Item,{title:e.tab,key:e.key},e.tab)))),t.createElement("div",{className:"demo-item-title"},"Setting className and style in Tab.Item"),t.createElement(Z,{shape:"wrapped",navStyle:{background:"#DEE8FF"}},ae.map((e=>t.createElement(Z.Item,{title:e.tab,key:e.key,className:"custom-tab-item",style:{background:"#FFF"}},e.tab)))),t.createElement("div",{className:"demo-item-title"},"Tabs with same width"),t.createElement(Z,{shape:"capsule"},ae.map((e=>t.createElement(Z.Item,{title:e.tab,key:e.key,className:"justify-tabs-tab"},e.tab)))));return t.createElement(ie,null,e)}});const le=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var se=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Z,{disableKeyboard:!0},t.createElement(Z.Item,{title:"Home",key:"1"},"Home content"),t.createElement(Z.Item,{title:"Documentation",key:"2"},"Doc content"),t.createElement(Z.Item,{title:"Help",key:"3"},"Help Content"));return t.createElement(le,null,e)}});function ce({title:e,desc:n,img:a}){return t.createElement("div",{className:"custom-tab-item"},t.createElement("div",{className:"tab-title"},t.createElement("img",{className:"tab-img",src:a}),e),t.createElement("div",{className:"tab-desc"},n))}const pe=[{key:"e-checking",title:"Alipay",desc:"The fee to be paid is $15",img:"https://img.alicdn.com/tfs/TB1wra0otTfau8jSZFwXXX1mVXa-80-80.png"},{key:"brand-card",title:"Bank Card",desc:"The fee to be paid is $17",img:"https://img.alicdn.com/tfs/TB1nKE5s79l0K4jSZFKXXXFjpXa-67-65.png"}];const me=w.div`
  .custom-tab-item {
    padding: 10px;
  }
...
`;var de=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=t.createElement(Z,{shape:"wrapped",tabRender:(n,a)=>t.createElement(ce,e({key:n},a))},pe.map((n=>t.createElement(Z.Item,e(e({key:n.key},n),{tabStyle:{height:"60px"}}),n.desc))));return t.createElement(me,null,n)}});const ue=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var be=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Z,null,t.createElement(Z.Item,{title:"Tab 1",disabled:!0,key:"1"},"Tab 1 content"),t.createElement(Z.Item,{title:"Tab 2",key:"2"},"Tab 2 content"),t.createElement(Z.Item,{title:"Tab 3",key:"3"},"Tab 3 content"));return t.createElement(ue,null,e)}});function fe(e){console.log(e)}const ye=t.createElement(T,{type:"primary",onClick:function(){console.log("hello world")}},"Hello world");const ve=w.div`
  .fusion-demo .demo-item-title {
    font-size: 16px;
    color: #333;
    padding: 8px;
...
`;var he=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},t.createElement("div",{className:"demo-item-title"},"Extra in Horizontal"),t.createElement(Z,{shape:"wrapped",onChange:fe,extra:ye},t.createElement(Z.Item,{title:"Tab 1",key:"1"},"Tab 1 Content"),t.createElement(Z.Item,{title:"Tab 2",key:"2"},"Tab 2 Content"),t.createElement(Z.Item,{title:"Tab 3",key:"3"},"Tab 3 Content")),t.createElement("div",{className:"demo-item-title"},"Extra in Vertical"),t.createElement(Z,{shape:"wrapped",tabPosition:"left",onChange:fe,extra:ye,contentClassName:"custom-tab-content"},t.createElement(Z.Item,{title:"Tab 1",key:"1"},"Tab 1 Content"),t.createElement(Z.Item,{title:"Tab 2",key:"2"},"Tab 2 Content"),t.createElement(Z.Item,{title:"Tab 3",key:"3"},"Tab 3 Content")));return t.createElement(ve,null,e)}});class ge extends t.Component{constructor(e){super(e),this.onKeyDown=e=>{const{keyCode:t}=e;t>36&&t<41&&e.stopPropagation()},this.onBlur=e=>{this.setState({editable:!1,tabTitle:e.target.value})},this.onDblClick=()=>{this.setState({editable:!0})},this.state={tabTitle:e.defaultTitle,editable:!1}}componentWillReceiveProps(e){e.defaultTitle!==this.state.tabTitle&&this.setState({tabTitle:e.defaultTitle})}render(){const{tabTitle:e,editable:n}=this.state;return n?t.createElement(k,{defaultValue:e,onKeyDown:this.onKeyDown,onBlur:this.onBlur}):t.createElement("span",{onDoubleClick:this.onDblClick},e)}}const Ee=(e,{title:n})=>t.createElement("div",{key:e,className:"editable-tab-wrapper"},t.createElement(ge,{defaultTitle:n}));const Te=w.div`
...
`;var ke=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Z,{defaultActiveKey:"1",tabRender:Ee},t.createElement(Z.Item,{title:"Double Click To Edit Me",key:"1"},"Editable tab"),t.createElement(Z.Item,{title:"Double Click To Edit Me",key:"2"},"Editable tab"));return t.createElement(Te,null,e)}});const xe=[{tab:"Home",key:1},{tab:"Documnet",key:2},{tab:"Setting",key:3},{tab:"Help",key:4},{tab:"Admin",key:5},{tab:"More 1",key:6},{tab:"More 2",key:7},{tab:"More 3",key:8},{tab:"More 4",key:9},{tab:"More 5",key:10},{tab:"More 6",key:11},{tab:"More 7",key:12},{tab:"More 8",key:13},{tab:"More 9",key:14},{tab:"More 10",key:15},{tab:"More 11",key:16}];function Ce(e){console.log(e)}const we=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var Ie=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo",style:{maxWidth:"520px"}},t.createElement(Z,{excessMode:"dropdown"},xe.map((e=>t.createElement(Z.Item,{key:e.key,title:e.tab,onClick:Ce},e.tab," content, content, content")))),t.createElement("br",null),t.createElement(Z,{excessMode:"slide"},xe.map((e=>t.createElement(Z.Item,{key:e.key,title:e.tab,onClick:Ce},e.tab," content, content, content")))));return t.createElement(we,null,e)}});function Ne(e){console.log(e)}const _e=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var Se=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Z,{onChange:Ne,shape:"wrapped"},t.createElement(Z.Item,{title:"Tab 1",key:"1"},t.createElement(Z,{shape:"wrapped"},t.createElement(Z.Item,{title:"1-1",key:"11"},"1-1"),t.createElement(Z.Item,{title:"1-2",key:"12"},"1-2"),t.createElement(Z.Item,{title:"1-3",key:"13"},"1-3"))),t.createElement(Z.Item,{title:"Tab 2",key:"2"},t.createElement(Z,{shape:"pure"},t.createElement(Z.Item,{title:"2-1",key:"21"},"2-1"),t.createElement(Z.Item,{title:"2-2",key:"22"},"2-2"),t.createElement(Z.Item,{title:"3-3",key:"23"},"2-3"))),t.createElement(Z.Item,{title:"Tab 3",key:"3"},t.createElement(Z,{shape:"capsule"},t.createElement(Z.Item,{title:"3-1",key:"31"},"3-1"),t.createElement(Z.Item,{title:"3-2",key:"32"},"3-2"),t.createElement(Z.Item,{title:"3-3",key:"33"},"3-3"))),t.createElement(Z.Item,{title:"Tab 4",key:"4"},t.createElement(Z,{shape:"text"},t.createElement(Z.Item,{title:"4-1",key:"41"},"4-1"),t.createElement(Z.Item,{title:"4-2",key:"42"},"4-2"),t.createElement(Z.Item,{title:"4-3",key:"43"},"4-3"))));return t.createElement(_e,null,e)}});const Me=[{tab:"Home",key:0,content:"This is home page"},{tab:"Document",key:1,content:"This is document page"},{tab:"API",key:2,content:"This is api page"}];const ze=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var Ke=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement("div",null,"use lazyLoad=false to render all tab items"),t.createElement(Z,{lazyLoad:!1},Me.map((e=>t.createElement(Z.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("br",null),t.createElement("div",null,"Unmount other items while switch tab"),t.createElement(Z,{unmountInactiveTabs:!0},Me.map((e=>t.createElement(Z.Item,{key:e.key,title:e.tab},e.content)))));return t.createElement(ze,null,e)}});const De=()=>{const[e,n]=t.useState("top");return t.createElement("div",null,"Position:"," ",t.createElement(x.Group,{shape:"button",value:e,onChange:n},t.createElement(x,{value:"top"},"top"),t.createElement(x,{value:"bottom"},"bottom"),t.createElement(x,{value:"left"},"left"),t.createElement(x,{value:"right"},"right")),t.createElement("br",null),t.createElement("br",null),t.createElement(Z,{tabPosition:e,shape:"wrapped",contentClassName:"custom-tab-content"},t.createElement(Z.Item,{title:"Tab 1",key:"1"},"Tab 1 Content"),t.createElement(Z.Item,{title:"Tab 2",key:"2"},"Tab 2 Content"),t.createElement(Z.Item,{title:"Tab 3",key:"3"},"Tab 3 Content")))};const Oe=w.div`
  .custom-tab-content {
    min-height: 50px;
  }
...
`;var Be=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(De,null);return t.createElement(Oe,null,e)}});const Pe=[{tab:"Home",key:"home",content:"This is home page"},{tab:"Document",key:"doc",content:"This is document page"},{tab:"API",key:"api",content:"This is api page"}];const je=w.div`
  .next-tabs-content {
    color: #333;
    font-size: 12px;
    padding: 12px;
  }
`;var He=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement(Z,{size:"small"},Pe.map((e=>t.createElement(Z.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("br",null),t.createElement(Z,{size:"small",shape:"wrapped"},Pe.map((e=>t.createElement(Z.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("br",null),t.createElement(Z,{size:"small",shape:"text"},Pe.map((e=>t.createElement(Z.Item,{key:e.key,title:e.tab},e.content)))),t.createElement("br",null),t.createElement(Z,{size:"small",shape:"capsule"},Pe.map((e=>t.createElement(Z.Item,{key:e.key,title:e.tab},e.content)))));return t.createElement(je,null,e)}});const{Row:Re,Col:Ae}=C,Le=function(e){const t=[];for(let n=1;n<15;n++)t.push({tab:`tab ${n}`,key:n,content:`tab ${n} content`});return t}();const We=w.div`
  .custom-row {
...
`;var Fe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"custom-wrapper"},t.createElement(Re,{className:"custom-row"},t.createElement(Ae,{fixedSpan:"12",className:"custom-col-sidebar"},"Sidebar"),t.createElement(Ae,{className:"custom-col-content"},t.createElement(Z,null,Le.map((e=>t.createElement(Z.Item,{key:e.key,title:e.tab},e.content)))))));return t.createElement(We,null,e)}});function Xe(e){console.log(e)}const Ue=()=>{const[e,n]=t.useState("pure");return t.createElement("div",null,"shape:"," ",t.createElement(x.Group,{shape:"button",value:e,onChange:n},t.createElement(x,{value:"pure"},"pure"),t.createElement(x,{value:"wrapped"},"wrapped"),t.createElement(x,{value:"text"},"text"),t.createElement(x,{value:"capsule"},"capsule")),t.createElement("br",null),t.createElement("br",null),t.createElement(Z,{shape:e,onChange:Xe},t.createElement(Z.Item,{key:"home",title:"Home"},"This is home page"),t.createElement(Z.Item,{key:"document",title:"Document"},"This is document page"),t.createElement(Z.Item,{key:"api",title:"API"},"This is api page"),t.createElement(Z.Item,{key:"repo",title:"Repo"},"This is repo link")))};const Ve=w.div``;var Ge=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(Ue,null);return t.createElement(Ve,null,e)}});const $e=[{tab:"Home",key:0,content:"This is home page"},{tab:"Document",key:1,content:"This is document page"},{tab:"API",key:2,content:"This is api page"}];function qe(e){console.log("change",e)}function Ze(e){console.log("click",e)}function Je(e,t){console.log("enter",t.target,e)}function Qe(e,t){console.log("leave",t.target,e)}const Ye=w.div`
  .fusion-demo .demo-item-title {
    font-size: 16px;
    color: #333;
    padding: 8px;
...
`;var et=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",{className:"fusion-demo"},t.createElement("div",{className:"demo-item-title"},"Click to change"),t.createElement(Z,{triggerType:"click",onChange:qe},$e.map((e=>t.createElement(Z.Item,{key:e.key,title:e.tab,onClick:Ze},e.content)))),t.createElement("div",{className:"demo-item-title"},"Hover to change"),t.createElement(Z,{triggerType:"hover",onChange:qe},$e.map((e=>t.createElement(Z.Item,{key:e.key,title:e.tab,onClick:Ze,onMouseEnter:Je,onMouseLeave:Qe},e.content)))));return t.createElement(Ye,null,e)}});const tt={};tt._basic=Q,tt._closable=ne,tt["_custom-style"]=re,tt["_disable-keyboard"]=se,tt["_custom-tab"]=de,tt._disabled=be,tt._extra=he,tt["_editable-tab"]=ke,tt["_excess-mode"]=Ie,tt._nested=Se,tt["_lazy-load"]=Ke,tt._position=Be,tt._size=He,tt["_tab-in-grid"]=Fe,tt._shape=Ge,tt["_trigger-type"]=et;export default tt;
