import{r as e,ac as t,R as n}from"./index.4272a92a.js";import{q as l}from"./styled-components.browser.esm.6c715b82.js";const{Item:a,SubNav:o}=t,r=e.createElement("span",{className:"fusion"},"FUSION"),c=e.createElement("a",{className:"login-in",href:"javascript:;"},"Login in");const m=l.div`
  .basic-nav .fusion {
    margin: 8px 20px;
    width: 100px;
    color: #ffffff;
...
`;var M=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement(w,null);return e.createElement(O,null,t)}});const{Item:C,Group:G}=t;const j=l.div``;var A=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const n=e.createElement(t,{style:{width:240}},e.createElement(G,{label:"Group Label 1"},e.createElement(C,{icon:"account"},"Navigation One"),e.createElement(C,{icon:"account"},"Navigation Two"),e.createElement(C,{icon:"account"},"Navigation Three")),e.createElement(G,{label:"Group Label 2"},e.createElement(C,{icon:"account"},"Navigation Four"),e.createElement(C,{icon:"account"},"Navigation Five"),e.createElement(C,{icon:"account"},"Navigation Six")));return e.createElement(j,null,n)}});const V={};V._basic=i,V["_icon-only"]=E,V._custom=f,V._fixed=I,V["_open-mode"]=T,V["_popup-align"]=M,V._group=A;export default V;
