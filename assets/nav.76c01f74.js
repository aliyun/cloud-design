import{r as e,ac as t,R as n}from"./index.4642f55c.js";import{q as l}from"./styled-components.browser.esm.1feaecc0.js";const{Item:a,SubNav:o}=t,r=e.createElement("span",{className:"fusion"},"FUSION"),c=e.createElement("a",{className:"login-in",href:"javascript:;"},"Login in");const m=l.div`
  .basic-nav .fusion {
    margin: 8px 20px;
    width: 100px;
    color: #ffffff;
...
`;var A=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const t=e.createElement(G,null);return e.createElement(j,null,t)}});const V={};V._basic=i,V._fixed=s,V._custom=b,V._group=y,V["_popup-align"]=_,V["_icon-only"]=O,V["_open-mode"]=A;export default V;
