...
`;var E=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(a,{className:"media-card",free:!0},t.createElement(a.Media,null,t.createElement("img",{src:"https://img.alicdn.com/tfs/TB1FNIOSFXXXXaWXXXXXXXXXXXX-260-188.png"})),t.createElement(a.Header,{title:"Title",subTitle:"Sub Title",extra:[t.createElement(n,{type:"primary",key:"action1",text:!0},"More")]}),t.createElement(a.Content,null,"Lorem ipsum dolor sit amet, est viderer iuvaret perfecto et. Ne petentium quaerendum nec, eos ex recteque mediocritatem, ex usu assum legendos temporibus. Ius feugiat pertinacia an, cu verterem praesent quo."),t.createElement(a.Actions,null,t.createElement(n,{type:"primary",key:"action1",text:!0},"Action 1"),t.createElement(n,{type:"primary",key:"action2",text:!0},"Action 2")));return t.createElement(p,null,e)}});const f={subTitle:"SubTitle",extra:t.createElement(n,{text:!0,type:"primary"},"Link")};const y=l.div`
  .card-placeholder {
    height: 200px;
  }
`;var g=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const r=t.createElement("div",null,t.createElement(a,{free:!0,style:{width:300}},t.createElement(a.Header,e({title:"Simple Card"},f)),t.createElement(a.Content,null,"Lorem ipsum dolor sit amet, est viderer iuvaret perfecto et. Ne petentium quaerendum nec, eos ex recteque mediocritatem, ex usu assum legendos temporibus. Ius feugiat pertinacia an, cu verterem praesent quo.")));return t.createElement(y,null,r)}});const x={extra:t.createElement(a.DropDownActions,{actions:[{label:"Action1",onClick:()=>{console.log("Action1 clicked")}},{label:"Action2",onClick:()=>{console.log("Action2 clicked")}}]})};const X=l.div`
  .card-placeholder {
    height: 200px;
  }
`;var v=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){return t.createElement(X,null,t.createElement("div",null,t.createElement(a,{free:!0,style:{width:300}},t.createElement(a.Header,e({title:"Simple Card"},x)),t.createElement(a.Content,null,"Lorem ipsum dolor sit amet, est viderer iuvaret perfecto et. Ne petentium quaerendum nec, eos ex recteque mediocritatem, ex usu assum legendos temporibus. Ius feugiat pertinacia an, cu verterem praesent quo."))))}});const b={};b._divider=o,b._free=u,b["_collapsable-head"]=s,b["_collapsable-tail"]=d,b._media=E,b._basic=g,b["_header-actions"]=v;export default b;
