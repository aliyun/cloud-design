...
`;var v=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=o.createElement(f,null);return o.createElement(x,null,e)}});const{SubMenu:_,Item:O}=c;const w=i.div`
  .my-menu {
    width: 200px;
  }
`;var C=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=o.createElement(c,{defaultOpenKeys:"1",className:"my-menu",openMode:"single"},o.createElement(_,{key:"0",label:"Sub menu 1"},o.createElement(O,{key:"0-0"},"Sub option 1"),o.createElement(O,{key:"0-1"},"Sub option 2"),o.createElement(O,{key:"0-2"},"Sub option 3")),o.createElement(_,{key:"1",label:"Sub menu 2"},o.createElement(O,{key:"1-0"},"Sub option 1"),o.createElement(O,{key:"1-1"},"Sub option 2"),o.createElement(O,{key:"1-2"},"Sub option 3")),o.createElement(_,{key:"2",label:"Sub menu 3"},o.createElement(O,{key:"2-0"},"Sub option 1"),o.createElement(O,{key:"2-1"},"Sub option 2"),o.createElement(O,{key:"2-2"},"Sub option 3")),o.createElement(_,{key:"3",label:"Sub menu 4"},o.createElement(O,{key:"3-0"},"Sub option 1"),o.createElement(O,{key:"3-1"},"Sub option 2"),o.createElement(O,{key:"3-2"},"Sub option 3")));return o.createElement(w,null,e)}});const{SubMenu:M,Item:I,Divider:P}=c;class N extends o.Component{constructor(e){super(e),this.createContextMenu=e=>{e.preventDefault();const t=e.target,{top:n,left:l}=t.getBoundingClientRect();c.create({target:e.target,offset:[e.clientX-l,e.clientY-n],className:"context-menu",popupClassName:"context-menu",onItemClick:console.log,selectedKeys:this.state.selectedKeys,selectMode:"multiple",onSelect:this.handleSelect,children:[o.createElement(I,{key:"1"},"Option 1"),o.createElement(I,{key:"2"},"Option 2"),o.createElement(I,{key:"3"},"Option 3"),o.createElement(P,{key:"divider-1"}),o.createElement(M,{key:"sub-menu",label:"Sub menu"},o.createElement(I,{key:"sub-1"},"Sub option 1"),o.createElement(I,{key:"sub-2"},"Sub option 2")),o.createElement(I,{key:"4"},"Option 4"),o.createElement(P,{key:"divider-2"}),o.createElement(I,{key:"5"},"Option 5")]})},this.state={selectedKeys:[]},this.handleSelect=this.handleSelect.bind(this)}handleSelect(e){e=e.filter((e=>["sub-1","sub-2"].indexOf(e)>-1)),this.setState({selectedKeys:e})}render(){return o.createElement("div",{className:"context-demo",onContextMenu:this.createContextMenu},"Right click here to see the context menu!")}}const z=i.div`
  .context-demo {
    width: 500px;
    height: 200px;
    line-height: 200px;
...
`;var D=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=o.createElement(N,null);return o.createElement(z,null,e)}});const{PopupItem:j}=c;class T extends o.Component{render(){const e={target:()=>ReactDOM.findDOMNode(this),offset:[-1,0],animation:!1};return o.createElement(c,{className:"my-custom-menu",popupProps:e},o.createElement(j,{key:"0",label:"Popup item 1"},o.createElement("div",{className:"my-custom-content"},"Custom content 1")),o.createElement(j,{key:"1",label:"Popup item 2"},o.createElement("div",{className:"my-custom-content"},"Custom content 2")),o.createElement(j,{key:"2",label:"Popup item 3"},o.createElement("div",{className:"my-custom-content"},"Custom content 3")),o.createElement(j,{key:"3",label:"Popup item 4"},o.createElement("div",{className:"my-custom-content"},"Custom content 4")))}}const K=i.div`
  .my-custom-menu {
    width: 200px;
