...
`;var ne=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement(i,{tip:"default animation"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{indicator:X},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{indicator:ee},t.createElement("div",{className:"demo"},"test")));return t.createElement(te,null,e)}});const re=m.div`
  .demo {
    width: 500px;
    background-color: #f2f3f7;
    text-align: center;
...
`;var ae=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement(i,{tip:"normal(size default large)"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{tip:"large",size:"large"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{tip:"medium",size:"medium"},t.createElement("div",{className:"demo"},"test")));return t.createElement(re,null,e)}});const oe=m.div`
  .demo {
    width: 500px;
    background-color: #f2f3f7;
    text-align: center;
...
`;var ie=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement("div",null,"LTR",t.createElement(i,{tip:"加载中..."},t.createElement("div",{className:"demo"},"test"))),t.createElement("div",null,"RTL",t.createElement(i,{tip:"加载中...",rtl:!0},t.createElement("div",{className:"demo"},"test"))));return t.createElement(oe,null,e)}});var le=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:e=>t.createElement("div",null,t.createElement("div",{style:{width:400}},t.createElement(Z,{count:5})),t.createElement("p",null,"本骨架屏组件导出自",t.createElement("a",{href:"https://www.npmjs.com/package/react-loading-skeleton",target:"_blank"},"react-loading-skeleton"),"，更多用法请查阅它的文档。"))});const se=s.Item,ce={labelCol:{fixedSpan:4},wrapperCol:{span:18}};class ue extends t.Component{constructor(e){super(e),this.state={visible:!1}}setVisible(e){this.setState({visible:e})}render(){return t.createElement("div",null,t.createElement(i,{visible:this.state.visible,shape:"fusion-reactor"},t.createElement(s,{style:{width:500}},t.createElement(se,e({label:"Username"},ce),t.createElement(c,null)),t.createElement(se,e({label:"Password"},ce),t.createElement(c,{htmlType:"password",placeholder:"please input"})),t.createElement(se,e({label:"Detail"},ce),t.createElement(c,{multiple:!0})))),t.createElement("div",{style:{paddingLeft:80}},t.createElement(l,{onClick:this.setVisible.bind(this,!0),type:"primary"},"Submit"),t.createElement(l,{onClick:this.setVisible.bind(this,!1),style:{marginLeft:5}},"Cancel")))}}const de=m.div``;var fe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement(ue,null);return t.createElement(de,null,e)}});const me=m.div`
  .demo {
    width: 500px;
    background-color: #f2f3f7;
    text-align: center;
...
`;var he=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=t.createElement("div",null,t.createElement(i,{tip:"default"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{tip:"right",tipAlign:"right"},t.createElement("div",{className:"demo"},"test")),t.createElement(i,{tip:"bottom",tipAlign:"bottom"},t.createElement("div",{className:"demo"},"test")));return t.createElement(me,null,e)}});const pe={};pe._fullscreen=Q,pe._indicator=ne,pe._size=ae,pe._basic=ie,pe._skeleton=le,pe._state=fe,pe._tipAlign=he;export default pe;
