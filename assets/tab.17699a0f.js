...
`;var h=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=c.exports.createElement(k,null);return c.exports.createElement(f,null,e)}});const v=[{tab:"Todo Tasks",key:0},{tab:"Finished Tasks",key:1},{tab:"Unread Messages",key:2},{tab:"Past Messages",key:3},{tab:"All Messages",key:4}],T={border:"1px solid #DCDEE3",padding:"20px"};const _=u.div`
...
`;var ke=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:function(){const e=c.exports.createElement("div",{className:"fusion-demo"},c.exports.createElement("div",{className:"demo-item-title"},"Click to change"),c.exports.createElement(i,{triggerType:"click",onChange:be},de.map((e=>c.exports.createElement(i.Item,{key:e.key,title:e.tab,onClick:ue},e.content)))),c.exports.createElement("div",{className:"demo-item-title"},"Hover to change"),c.exports.createElement(i,{triggerType:"hover",onChange:be},de.map((e=>c.exports.createElement(i.Item,{key:e.key,title:e.tab,onClick:ue,onMouseEnter:ye,onMouseLeave:Ee},e.content)))));return c.exports.createElement(ge,null,e)}});const fe={};fe._basic=E,fe._closable=h,fe["_custom-style"]=I,fe["_custom-tab"]=w,fe["_disable-keyboard"]=j,fe._disabled=O,fe["_editable-tab"]=K,fe["_excess-mode"]=B,fe._extra=U,fe["_lazy-load"]=W,fe._nested=J,fe._position=ee,fe._shape=ae,fe._size=se,fe["_tab-in-grid"]=xe,fe["_trigger-type"]=ke;export default fe;
